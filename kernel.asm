...
801002e5:	e8 f6 3b 00 00       	call   80103ee0 <sleep>
    while(input.r == input.w){
...
8010042a:	e8 a1 58 00 00       	call   80105cd0 <uartputc>
...
80100515:	e8 b6 57 00 00       	call   80105cd0 <uartputc>
8010051a:	c7 04 24 20 00 00 00 	movl   $0x20,(%esp)
80100521:	e8 aa 57 00 00       	call   80105cd0 <uartputc>
80100526:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
8010052d:	e8 9e 57 00 00       	call   80105cd0 <uartputc>
...
80100b0a:	75 ce                	jne    80100ada <exec+0x5a>
  if((pgdir = setupkvm()) == 0)
80100b0c:	e8 2f 63 00 00       	call   80106e40 <setupkvm>
...
80100b73:	e8 e8 60 00 00       	call   80106c60 <allocuvm>
...
80100ba9:	e8 e2 5f 00 00       	call   80106b90 <loaduvm>
...
80100beb:	e8 d0 61 00 00       	call   80106dc0 <freevm>
  if(ip){
...
80100c32:	e8 29 60 00 00       	call   80106c60 <allocuvm>
...
80100c51:	31 ff                	xor    %edi,%edi
  clearpteu(pgdir, (char*)(sz - 2*PGSIZE));
80100c53:	e8 88 62 00 00       	call   80106ee0 <clearpteu>
  for(argc = 0; argv[argc]; argc++) {
...
80100ce1:	e8 da 60 00 00       	call   80106dc0 <freevm>
...
80100d2d:	89 8d 60 ff ff ff    	mov    %ecx,-0xa0(%ebp)
  if(copyout(pgdir, sp, ustack, (3+argc+1)*4) < 0)
80100d33:	e8 08 63 00 00       	call   80107040 <copyout>
...
80100d9e:	e8 5d 5c 00 00       	call   80106a00 <switchuvm>
  freevm(oldpgdir);
80100da3:	89 3c 24             	mov    %edi,(%esp)
80100da6:	e8 15 60 00 00       	call   80106dc0 <freevm>
  return 0;
...
80100dbd:	68 61 71 10 80       	push   $0x80107161
...
8010165e:	e8 bd 2f 00 00       	call   80104620 <memset>
      dip->type = type;
...
80101705:	e8 b6 2f 00 00       	call   801046c0 <memmove>
  log_write(bp);
...
80101743:	e8 c8 2d 00 00       	call   80104510 <acquire>
  ip->ref++;
80101748:	83 43 08 01          	addl   $0x1,0x8(%ebx)
  release(&icache.lock);
8010174c:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
80101753:	e8 78 2e 00 00       	call   801045d0 <release>
}
...
80101786:	e8 05 2b 00 00       	call   80104290 <acquiresleep>
  if(ip->valid == 0){
...
801017f8:	e8 c3 2e 00 00       	call   801046c0 <memmove>
    brelse(bp);
...
80101857:	e8 d4 2a 00 00       	call   80104330 <holdingsleep>
...
80101872:	5d                   	pop    %ebp
  releasesleep(&ip->lock);
80101873:	e9 78 2a 00 00       	jmp    801042f0 <releasesleep>
    panic("iunlock");
...
801018a4:	e8 e7 29 00 00       	call   80104290 <acquiresleep>
...
801018be:	e8 2d 2a 00 00       	call   801042f0 <releasesleep>
  acquire(&icache.lock);
801018c3:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
801018ca:	e8 41 2c 00 00       	call   80104510 <acquire>
  ip->ref--;
...
801018e3:	5d                   	pop    %ebp
  release(&icache.lock);
801018e4:	e9 e7 2c 00 00       	jmp    801045d0 <release>
801018e9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    acquire(&icache.lock);
801018f0:	83 ec 0c             	sub    $0xc,%esp
801018f3:	68 e0 09 11 80       	push   $0x801109e0
801018f8:	e8 13 2c 00 00       	call   80104510 <acquire>
    int r = ip->ref;
801018fd:	8b 73 08             	mov    0x8(%ebx),%esi
    release(&icache.lock);
80101900:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
80101907:	e8 c4 2c 00 00       	call   801045d0 <release>
    if(r == 1){
...
80101b07:	e8 b4 2b 00 00       	call   801046c0 <memmove>
    brelse(bp);
...
80101c03:	e8 b8 2a 00 00       	call   801046c0 <memmove>
    log_write(bp);
...
80101ca2:	e8 89 2a 00 00       	call   80104730 <strncmp>
}
80101ca7:	c9                   	leave  
80101ca8:	c3                   	ret    
...
80101d05:	e8 26 2a 00 00       	call   80104730 <strncmp>
      continue;
...
80101d9c:	e8 6f 27 00 00       	call   80104510 <acquire>
  ip->ref++;
80101da1:	83 46 08 01          	addl   $0x1,0x8(%esi)
  release(&icache.lock);
80101da5:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
80101dac:	e8 1f 28 00 00       	call   801045d0 <release>
...
80101e17:	e8 a4 28 00 00       	call   801046c0 <memmove>
...
80101ea3:	e8 18 28 00 00       	call   801046c0 <memmove>
    name[len] = 0;
...
80101fd5:	e8 a6 27 00 00       	call   80104780 <strncpy>
...
80102164:	e8 27 22 00 00       	call   80104390 <initlock>
...
801021f2:	e8 19 23 00 00       	call   80104510 <acquire>
...
8010224d:	e8 3e 1e 00 00       	call   80104090 <wakeup>
...
8010226b:	e8 60 23 00 00       	call   801045d0 <release>
...
80102292:	e8 99 20 00 00       	call   80104330 <holdingsleep>
...
801022cc:	e8 3f 22 00 00       	call   80104510 <acquire>
...
80102319:	e8 c2 1b 00 00       	call   80103ee0 <sleep>
  while((b->flags & (B_VALID|B_DIRTY)) != B_VALID){
...
80102335:	c9                   	leave  
  release(&idelock);
80102336:	e9 95 22 00 00       	jmp    801045d0 <release>
...
801024a6:	e8 75 21 00 00       	call   80104620 <memset>
...
801024e0:	e8 2b 20 00 00       	call   80104510 <acquire>
...
801024fa:	c9                   	leave  
    release(&kmem.lock);
801024fb:	e9 d0 20 00 00       	jmp    801045d0 <release>
    panic("kfree");
...
80102579:	e8 12 1e 00 00       	call   80104390 <initlock>
  p = (char*)PGROUNDUP((uint)vstart);
...
80102663:	e8 a8 1e 00 00       	call   80104510 <acquire>
  r = kmem.freelist;
...
80102691:	e8 3a 1f 00 00       	call   801045d0 <release>
  return (char*)r;
...
80102abf:	e8 ac 1b 00 00       	call   80104670 <memcmp>
...
80102bf4:	e8 c7 1a 00 00       	call   801046c0 <memmove>
...
80102ca8:	e8 e3 16 00 00       	call   80104390 <initlock>
  readsb(dev, &sb);
80102cad:	58                   	pop    %eax
...
80102d3f:	e8 cc 17 00 00       	call   80104510 <acquire>
...
80102d5d:	e8 7e 11 00 00       	call   80103ee0 <sleep>
...
80102d94:	e8 37 18 00 00       	call   801045d0 <release>
      break;
    }
  }
}
...
80102db2:	e8 59 17 00 00       	call   80104510 <acquire>
  log.outstanding -= 1;
...
80102df0:	e8 db 17 00 00       	call   801045d0 <release>
}
...
80102e0a:	e8 01 17 00 00       	call   80104510 <acquire>
    wakeup(&log);
...
80102e1d:	00 00 00 
    wakeup(&log);
80102e20:	e8 6b 12 00 00       	call   80104090 <wakeup>
    release(&log.lock);
80102e25:	c7 04 24 80 26 11 80 	movl   $0x80112680,(%esp)
80102e2c:	e8 9f 17 00 00       	call   801045d0 <release>
...
80102e84:	e8 37 18 00 00       	call   801046c0 <memmove>
...
80102ed8:	e8 b3 11 00 00       	call   80104090 <wakeup>
  release(&log.lock);
80102edd:	c7 04 24 80 26 11 80 	movl   $0x80112680,(%esp)
80102ee4:	e8 e7 16 00 00       	call   801045d0 <release>
...
80102f52:	e8 b9 15 00 00       	call   80104510 <acquire>
  for (i = 0; i < log.lh.n; i++) {
...
80102f94:	c9                   	leave  
  release(&log.lock);
80102f95:	e9 36 16 00 00       	jmp    801045d0 <release>
...
80103002:	e8 09 29 00 00       	call   80105910 <idtinit>
...
8010301a:	e8 01 0c 00 00       	call   80103c20 <scheduler>
8010301f:	90                   	nop
...
80103027:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
8010302a:	e8 b1 39 00 00       	call   801069e0 <switchkvm>
  seginit();
...
80103065:	e8 56 3e 00 00       	call   80106ec0 <kvmalloc>
...
80103088:	e8 83 2b 00 00       	call   80105c10 <uartinit>
  pinit();         // process table
8010308d:	e8 1e 08 00 00       	call   801038b0 <pinit>
  tvinit();        // trap vectors
80103092:	e8 f9 27 00 00       	call   80105890 <tvinit>
  binit();         // buffer cache
...
801030b8:	e8 03 16 00 00       	call   801046c0 <memmove>
...
801031a4:	e8 c7 14 00 00       	call   80104670 <memcmp>
...
80103260:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  if(memcmp(conf, "PCMP", 4) != 0)
80103263:	e8 08 14 00 00       	call   80104670 <memcmp>
...
8010346d:	e8 1e 0f 00 00       	call   80104390 <initlock>
  (*f0)->type = FD_PIPE;
...
80103513:	e8 f8 0f 00 00       	call   80104510 <acquire>
  if(writable){
...
80103533:	e8 58 0b 00 00       	call   80104090 <wakeup>
...
80103557:	5d                   	pop    %ebp
    release(&p->lock);
80103558:	e9 73 10 00 00       	jmp    801045d0 <release>
...
80103574:	e8 17 0b 00 00       	call   80104090 <wakeup>
...
80103584:	e8 47 10 00 00       	call   801045d0 <release>
    kfree((char*)p);
...
801035b1:	e8 5a 0f 00 00       	call   80104510 <acquire>
  for(i = 0; i < n; i++){
...
80103608:	e8 83 0a 00 00       	call   80104090 <wakeup>
      sleep(&p->nwrite, &p->lock);  //DOC: pipewrite-sleep
8010360d:	58                   	pop    %eax
8010360e:	5a                   	pop    %edx
8010360f:	53                   	push   %ebx
80103610:	56                   	push   %esi
80103611:	e8 ca 08 00 00       	call   80103ee0 <sleep>
    while(p->nwrite == p->nread + PIPESIZE){  //DOC: pipewrite-full
...
8010363c:	e8 8f 0f 00 00       	call   801045d0 <release>
        return -1;
...
8010368a:	e8 01 0a 00 00       	call   80104090 <wakeup>
  release(&p->lock);
8010368f:	89 1c 24             	mov    %ebx,(%esp)
80103692:	e8 39 0f 00 00       	call   801045d0 <release>
  return n;
...
801036ba:	e8 51 0e 00 00       	call   80104510 <acquire>
...
801036ed:	e8 ee 07 00 00       	call   80103ee0 <sleep>
  while(p->nread == p->nwrite && p->writeopen){  //DOC: pipe-empty
...
80103756:	e8 35 09 00 00       	call   80104090 <wakeup>
  release(&p->lock);
8010375b:	89 34 24             	mov    %esi,(%esp)
8010375e:	e8 6d 0e 00 00       	call   801045d0 <release>
  return i;
...
80103779:	e8 52 0e 00 00       	call   801045d0 <release>
      return -1;
...
801037a1:	e8 6a 0d 00 00       	call   80104510 <acquire>
...
801037dc:	89 15 04 a0 10 80    	mov    %edx,0x8010a004
  release(&ptable.lock);
801037e2:	e8 e9 0d 00 00       	call   801045d0 <release>
...
80103804:	89 53 1c             	mov    %edx,0x1c(%ebx)
  *(uint*)sp = (uint)trapret;
80103807:	c7 40 14 76 58 10 80 	movl   $0x80105876,0x14(%eax)
  p->context = (struct context*)sp;
...
8010383a:	e8 91 0d 00 00       	call   801045d0 <release>
}
...
8010386f:	e8 5c 0d 00 00       	call   801045d0 <release>
...
801038c4:	e8 c7 0a 00 00       	call   80104390 <initlock>
}
...
80103968:	83 ec 04             	sub    $0x4,%esp
  pushcli();
8010396b:	e8 a0 0a 00 00       	call   80104410 <pushcli>
  c = mycpu();
...
8010397b:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
  popcli();
80103981:	e8 da 0a 00 00       	call   80104460 <popcli>
}
80103986:	83 c4 04             	add    $0x4,%esp
...
801039a7:	e8 94 34 00 00       	call   80106e40 <setupkvm>
...
801039c5:	e8 46 31 00 00       	call   80106b10 <inituvm>
...
801039db:	e8 40 0c 00 00       	call   80104620 <memset>
...
80103a34:	68 50 76 10 80       	push   $0x80107650
80103a39:	50                   	push   %eax
80103a3a:	e8 a1 0d 00 00       	call   801047e0 <safestrcpy>
  p->cwd = namei("/");
80103a3f:	c7 04 24 59 76 10 80 	movl   $0x80107659,(%esp)
80103a46:	e8 e5 e5 ff ff       	call   80102030 <namei>
80103a4b:	89 43 6c             	mov    %eax,0x6c(%ebx)
  acquire(&ptable.lock);
80103a4e:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103a55:	e8 b6 0a 00 00       	call   80104510 <acquire>
  p->state = RUNNABLE;
80103a5a:	c7 43 10 03 00 00 00 	movl   $0x3,0x10(%ebx)
  release(&ptable.lock);
80103a61:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103a68:	e8 63 0b 00 00       	call   801045d0 <release>
}
...
80103a78:	68 37 76 10 80       	push   $0x80107637
...
80103a99:	8b 75 08             	mov    0x8(%ebp),%esi
  struct proc *curproc = myproc();
80103a9c:	e8 bf fe ff ff       	call   80103960 <myproc>
80103aa1:	89 c3                	mov    %eax,%ebx
  sz = curproc->sz;
80103aa3:	8b 40 04             	mov    0x4(%eax),%eax
  if(n > 0){
80103aa6:	85 f6                	test   %esi,%esi
80103aa8:	7f 1e                	jg     80103ac8 <growproc+0x38>
  } else if(n < 0){
80103aaa:	75 3c                	jne    80103ae8 <growproc+0x58>
  switchuvm(curproc);
80103aac:	83 ec 0c             	sub    $0xc,%esp
  curproc->sz = sz;
80103aaf:	89 43 04             	mov    %eax,0x4(%ebx)
  switchuvm(curproc);
80103ab2:	53                   	push   %ebx
80103ab3:	e8 48 2f 00 00       	call   80106a00 <switchuvm>
  return 0;
80103ab8:	83 c4 10             	add    $0x10,%esp
80103abb:	31 c0                	xor    %eax,%eax
}
...
80103acb:	01 c6                	add    %eax,%esi
80103acd:	56                   	push   %esi
80103ace:	50                   	push   %eax
80103acf:	ff 73 08             	pushl  0x8(%ebx)
80103ad2:	e8 89 31 00 00       	call   80106c60 <allocuvm>
80103ad7:	83 c4 10             	add    $0x10,%esp
80103ada:	85 c0                	test   %eax,%eax
80103adc:	75 ce                	jne    80103aac <growproc+0x1c>
      return -1;
80103ade:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80103ae3:	eb d8                	jmp    80103abd <growproc+0x2d>
...
80103af2:	e8 99 32 00 00       	call   80106d90 <deallocuvm>
80103af7:	83 c4 10             	add    $0x10,%esp
80103afa:	85 c0                	test   %eax,%eax
80103afc:	75 ae                	jne    80103aac <growproc+0x1c>
80103afe:	eb de                	jmp    80103ade <growproc+0x4e>
...
80103b0a:	83 ec 1c             	sub    $0x1c,%esp
  struct proc *curproc = myproc();
80103b0d:	e8 4e fe ff ff       	call   80103960 <myproc>
80103b12:	89 c3                	mov    %eax,%ebx
  if((np = allocproc()) == 0){
80103b14:	e8 77 fc ff ff       	call   80103790 <allocproc>
80103b19:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80103b1c:	85 c0                	test   %eax,%eax
80103b1e:	0f 84 c1 00 00 00    	je     80103be5 <fork+0xe5>
  if((np->pgdir = copyuvm(curproc->pgdir, curproc->sz)) == 0){
80103b24:	83 ec 08             	sub    $0x8,%esp
80103b27:	ff 73 04             	pushl  0x4(%ebx)
80103b2a:	89 c7                	mov    %eax,%edi
80103b2c:	ff 73 08             	pushl  0x8(%ebx)
80103b2f:	e8 dc 33 00 00       	call   80106f10 <copyuvm>
80103b34:	83 c4 10             	add    $0x10,%esp
80103b37:	89 47 08             	mov    %eax,0x8(%edi)
80103b3a:	85 c0                	test   %eax,%eax
80103b3c:	0f 84 aa 00 00 00    	je     80103bec <fork+0xec>
  np->sz = curproc->sz;
80103b42:	8b 43 04             	mov    0x4(%ebx),%eax
80103b45:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
80103b48:	89 41 04             	mov    %eax,0x4(%ecx)
  *np->tf = *curproc->tf;
80103b4b:	8b 79 1c             	mov    0x1c(%ecx),%edi
  np->parent = curproc;
80103b4e:	89 c8                	mov    %ecx,%eax
80103b50:	89 59 18             	mov    %ebx,0x18(%ecx)
  *np->tf = *curproc->tf;
80103b53:	b9 13 00 00 00       	mov    $0x13,%ecx
80103b58:	8b 73 1c             	mov    0x1c(%ebx),%esi
80103b5b:	f3 a5                	rep movsl %ds:(%esi),%es:(%edi)
  for(i = 0; i < NOFILE; i++)
80103b5d:	31 f6                	xor    %esi,%esi
  np->tf->eax = 0;
80103b5f:	8b 40 1c             	mov    0x1c(%eax),%eax
80103b62:	c7 40 1c 00 00 00 00 	movl   $0x0,0x1c(%eax)
  for(i = 0; i < NOFILE; i++)
80103b69:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    if(curproc->ofile[i])
80103b70:	8b 44 b3 2c          	mov    0x2c(%ebx,%esi,4),%eax
...
80103b87:	89 44 b2 2c          	mov    %eax,0x2c(%edx,%esi,4)
  for(i = 0; i < NOFILE; i++)
...
80103b96:	ff 73 6c             	pushl  0x6c(%ebx)
  safestrcpy(np->name, curproc->name, sizeof(curproc->name));
80103b99:	83 c3 70             	add    $0x70,%ebx
  np->cwd = idup(curproc->cwd);
80103b9c:	e8 8f db ff ff       	call   80101730 <idup>
80103ba1:	8b 7d e4             	mov    -0x1c(%ebp),%edi
  safestrcpy(np->name, curproc->name, sizeof(curproc->name));
80103ba4:	83 c4 0c             	add    $0xc,%esp
  np->cwd = idup(curproc->cwd);
80103ba7:	89 47 6c             	mov    %eax,0x6c(%edi)
  safestrcpy(np->name, curproc->name, sizeof(curproc->name));
80103baa:	8d 47 70             	lea    0x70(%edi),%eax
80103bad:	6a 10                	push   $0x10
80103baf:	53                   	push   %ebx
80103bb0:	50                   	push   %eax
80103bb1:	e8 2a 0c 00 00       	call   801047e0 <safestrcpy>
  pid = np->pid;
80103bb6:	8b 5f 14             	mov    0x14(%edi),%ebx
  acquire(&ptable.lock);
80103bb9:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103bc0:	e8 4b 09 00 00       	call   80104510 <acquire>
  np->state = RUNNABLE;
80103bc5:	c7 47 10 03 00 00 00 	movl   $0x3,0x10(%edi)
  release(&ptable.lock);
80103bcc:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103bd3:	e8 f8 09 00 00       	call   801045d0 <release>
  return pid;
...
80103bf2:	ff 73 0c             	pushl  0xc(%ebx)
80103bf5:	e8 76 e8 ff ff       	call   80102470 <kfree>
    np->kstack = 0;
80103bfa:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
    return -1;
...
80103c2a:	83 ec 0c             	sub    $0xc,%esp
  struct cpu *c = mycpu();
80103c2d:	e8 9e fc ff ff       	call   801038d0 <mycpu>
  c->proc = 0;
80103c32:	c7 80 ac 00 00 00 00 	movl   $0x0,0xac(%eax)
80103c39:	00 00 00 
  struct cpu *c = mycpu();
80103c3c:	89 c6                	mov    %eax,%esi
  c->proc = 0;
...
80103c49:	83 ec 0c             	sub    $0xc,%esp
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103c4c:	bb 54 2d 11 80       	mov    $0x80112d54,%ebx
    acquire(&ptable.lock);
80103c51:	68 20 2d 11 80       	push   $0x80112d20
80103c56:	e8 b5 08 00 00       	call   80104510 <acquire>
80103c5b:	83 c4 10             	add    $0x10,%esp
80103c5e:	66 90                	xchg   %ax,%ax
      if(p->state != RUNNABLE)
80103c60:	83 7b 10 03          	cmpl   $0x3,0x10(%ebx)
...
80103c75:	58                   	pop    %eax
80103c76:	5a                   	pop    %edx
80103c77:	ff 73 20             	pushl  0x20(%ebx)
80103c7a:	57                   	push   %edi
      p->state = RUNNING;
80103c7b:	c7 43 10 04 00 00 00 	movl   $0x4,0x10(%ebx)
      swtch(&(c->scheduler), p->context);
80103c82:	e8 bc 0b 00 00       	call   80104843 <swtch>
      switchkvm();
80103c87:	e8 54 2d 00 00       	call   801069e0 <switchkvm>
      c->proc = 0;
...
80103cac:	e8 1f 09 00 00       	call   801045d0 <release>
    sti();
80103cb1:	83 c4 10             	add    $0x10,%esp
80103cb4:	eb 92                	jmp    80103c48 <scheduler+0x28>
...
80103cc9:	e8 92 fc ff ff       	call   80103960 <myproc>
  if(!holding(&ptable.lock))
80103cce:	83 ec 0c             	sub    $0xc,%esp
80103cd1:	68 20 2d 11 80       	push   $0x80112d20
  struct proc *p = myproc();
80103cd6:	89 c3                	mov    %eax,%ebx
  if(!holding(&ptable.lock))
80103cd8:	e8 e3 07 00 00       	call   801044c0 <holding>
80103cdd:	83 c4 10             	add    $0x10,%esp
80103ce0:	85 c0                	test   %eax,%eax
80103ce2:	74 4f                	je     80103d33 <sched+0x73>
  if(mycpu()->ncli != 1)
80103ce4:	e8 e7 fb ff ff       	call   801038d0 <mycpu>
80103ce9:	83 b8 a4 00 00 00 01 	cmpl   $0x1,0xa4(%eax)
80103cf0:	75 68                	jne    80103d5a <sched+0x9a>
  if(p->state == RUNNING)
80103cf2:	83 7b 10 04          	cmpl   $0x4,0x10(%ebx)
80103cf6:	74 55                	je     80103d4d <sched+0x8d>
  asm volatile("pushfl; popl %0" : "=r" (eflags));
80103cf8:	9c                   	pushf  
80103cf9:	58                   	pop    %eax
  if(readeflags()&FL_IF)
80103cfa:	f6 c4 02             	test   $0x2,%ah
80103cfd:	75 41                	jne    80103d40 <sched+0x80>
  intena = mycpu()->intena;
80103cff:	e8 cc fb ff ff       	call   801038d0 <mycpu>
  swtch(&p->context, mycpu()->scheduler);
80103d04:	83 c3 20             	add    $0x20,%ebx
  intena = mycpu()->intena;
80103d07:	8b b0 a8 00 00 00    	mov    0xa8(%eax),%esi
  swtch(&p->context, mycpu()->scheduler);
80103d0d:	e8 be fb ff ff       	call   801038d0 <mycpu>
80103d12:	83 ec 08             	sub    $0x8,%esp
80103d15:	ff 70 04             	pushl  0x4(%eax)
80103d18:	53                   	push   %ebx
80103d19:	e8 25 0b 00 00       	call   80104843 <swtch>
  mycpu()->intena = intena;
80103d1e:	e8 ad fb ff ff       	call   801038d0 <mycpu>
}
80103d23:	83 c4 10             	add    $0x10,%esp
  mycpu()->intena = intena;
80103d26:	89 b0 a8 00 00 00    	mov    %esi,0xa8(%eax)
}
...
80103d7a:	83 ec 0c             	sub    $0xc,%esp
  struct proc *curproc = myproc();
80103d7d:	e8 de fb ff ff       	call   80103960 <myproc>
  if(curproc == initproc)
80103d82:	39 05 b8 a5 10 80    	cmp    %eax,0x8010a5b8
80103d88:	0f 84 f9 00 00 00    	je     80103e87 <exit+0x117>
80103d8e:	89 c3                	mov    %eax,%ebx
80103d90:	8d 70 2c             	lea    0x2c(%eax),%esi
80103d93:	8d 78 6c             	lea    0x6c(%eax),%edi
80103d96:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80103d9d:	8d 76 00             	lea    0x0(%esi),%esi
    if(curproc->ofile[fd]){
80103da0:	8b 06                	mov    (%esi),%eax
80103da2:	85 c0                	test   %eax,%eax
80103da4:	74 12                	je     80103db8 <exit+0x48>
      fileclose(curproc->ofile[fd]);
80103da6:	83 ec 0c             	sub    $0xc,%esp
80103da9:	50                   	push   %eax
80103daa:	e8 11 d1 ff ff       	call   80100ec0 <fileclose>
      curproc->ofile[fd] = 0;
80103daf:	c7 06 00 00 00 00    	movl   $0x0,(%esi)
80103db5:	83 c4 10             	add    $0x10,%esp
  for(fd = 0; fd < NOFILE; fd++){
80103db8:	83 c6 04             	add    $0x4,%esi
80103dbb:	39 f7                	cmp    %esi,%edi
80103dbd:	75 e1                	jne    80103da0 <exit+0x30>
  begin_op();
80103dbf:	e8 6c ef ff ff       	call   80102d30 <begin_op>
  iput(curproc->cwd);
80103dc4:	83 ec 0c             	sub    $0xc,%esp
80103dc7:	ff 73 6c             	pushl  0x6c(%ebx)
80103dca:	e8 c1 da ff ff       	call   80101890 <iput>
  end_op();
80103dcf:	e8 cc ef ff ff       	call   80102da0 <end_op>
  curproc->cwd = 0;
80103dd4:	c7 43 6c 00 00 00 00 	movl   $0x0,0x6c(%ebx)
  acquire(&ptable.lock);
80103ddb:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103de2:	e8 29 07 00 00       	call   80104510 <acquire>
  wakeup1(curproc->parent);
80103de7:	8b 53 18             	mov    0x18(%ebx),%edx
...
80103dfb:	3d 54 4d 11 80       	cmp    $0x80114d54,%eax
80103e00:	74 1c                	je     80103e1e <exit+0xae>
    if(p->state == SLEEPING && p->chan == chan)
80103e02:	83 78 10 02          	cmpl   $0x2,0x10(%eax)
80103e06:	75 f0                	jne    80103df8 <exit+0x88>
80103e08:	3b 50 24             	cmp    0x24(%eax),%edx
80103e0b:	75 eb                	jne    80103df8 <exit+0x88>
      p->state = RUNNABLE;
80103e0d:	c7 40 10 03 00 00 00 	movl   $0x3,0x10(%eax)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103e14:	83 e8 80             	sub    $0xffffff80,%eax
80103e17:	3d 54 4d 11 80       	cmp    $0x80114d54,%eax
...
80103e33:	81 fa 54 4d 11 80    	cmp    $0x80114d54,%edx
80103e39:	74 33                	je     80103e6e <exit+0xfe>
    if(p->parent == curproc){
80103e3b:	39 5a 18             	cmp    %ebx,0x18(%edx)
80103e3e:	75 f0                	jne    80103e30 <exit+0xc0>
      if(p->state == ZOMBIE)
80103e40:	83 7a 10 05          	cmpl   $0x5,0x10(%edx)
      p->parent = initproc;
80103e44:	89 4a 18             	mov    %ecx,0x18(%edx)
      if(p->state == ZOMBIE)
...
80103e58:	74 d6                	je     80103e30 <exit+0xc0>
    if(p->state == SLEEPING && p->chan == chan)
80103e5a:	83 78 10 02          	cmpl   $0x2,0x10(%eax)
80103e5e:	75 f0                	jne    80103e50 <exit+0xe0>
80103e60:	3b 48 24             	cmp    0x24(%eax),%ecx
80103e63:	75 eb                	jne    80103e50 <exit+0xe0>
      p->state = RUNNABLE;
80103e65:	c7 40 10 03 00 00 00 	movl   $0x3,0x10(%eax)
80103e6c:	eb e2                	jmp    80103e50 <exit+0xe0>
  curproc->state = ZOMBIE;
80103e6e:	c7 43 10 05 00 00 00 	movl   $0x5,0x10(%ebx)
  sched();
80103e75:	e8 46 fe ff ff       	call   80103cc0 <sched>
  panic("zombie exit");
80103e7a:	83 ec 0c             	sub    $0xc,%esp
80103e7d:	68 a8 76 10 80       	push   $0x801076a8
80103e82:	e8 09 c5 ff ff       	call   80100390 <panic>
    panic("init exiting");
80103e87:	83 ec 0c             	sub    $0xc,%esp
80103e8a:	68 9b 76 10 80       	push   $0x8010769b
...
80103eaf:	e8 5c 06 00 00       	call   80104510 <acquire>
  myproc()->state = RUNNABLE;
80103eb4:	e8 a7 fa ff ff       	call   80103960 <myproc>
80103eb9:	c7 40 10 03 00 00 00 	movl   $0x3,0x10(%eax)
  sched();
80103ec0:	e8 fb fd ff ff       	call   80103cc0 <sched>
  release(&ptable.lock);
80103ec5:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103ecc:	e8 ff 06 00 00       	call   801045d0 <release>
}
...
80103eed:	8b 7d 08             	mov    0x8(%ebp),%edi
80103ef0:	8b 75 0c             	mov    0xc(%ebp),%esi
  struct proc *p = myproc();
80103ef3:	e8 68 fa ff ff       	call   80103960 <myproc>
  if(p == 0)
80103ef8:	85 c0                	test   %eax,%eax
80103efa:	0f 84 8b 00 00 00    	je     80103f8b <sleep+0xab>
  if(lk == 0)
80103f00:	85 f6                	test   %esi,%esi
80103f02:	74 7a                	je     80103f7e <sleep+0x9e>
80103f04:	89 c3                	mov    %eax,%ebx
  if(lk != &ptable.lock){  //DOC: sleeplock0
80103f06:	81 fe 20 2d 11 80    	cmp    $0x80112d20,%esi
80103f0c:	74 52                	je     80103f60 <sleep+0x80>
    acquire(&ptable.lock);  //DOC: sleeplock1
80103f0e:	83 ec 0c             	sub    $0xc,%esp
80103f11:	68 20 2d 11 80       	push   $0x80112d20
80103f16:	e8 f5 05 00 00       	call   80104510 <acquire>
    release(lk);
80103f1b:	89 34 24             	mov    %esi,(%esp)
80103f1e:	e8 ad 06 00 00       	call   801045d0 <release>
  p->chan = chan;
80103f23:	89 7b 24             	mov    %edi,0x24(%ebx)
  p->state = SLEEPING;
80103f26:	c7 43 10 02 00 00 00 	movl   $0x2,0x10(%ebx)
  sched();
80103f2d:	e8 8e fd ff ff       	call   80103cc0 <sched>
  p->chan = 0;
80103f32:	c7 43 24 00 00 00 00 	movl   $0x0,0x24(%ebx)
    release(&ptable.lock);
80103f39:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103f40:	e8 8b 06 00 00       	call   801045d0 <release>
    acquire(lk);
80103f45:	89 75 08             	mov    %esi,0x8(%ebp)
...
80103f51:	5d                   	pop    %ebp
    acquire(lk);
80103f52:	e9 b9 05 00 00       	jmp    80104510 <acquire>
80103f57:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80103f5e:	66 90                	xchg   %ax,%ax
  p->chan = chan;
80103f60:	89 78 24             	mov    %edi,0x24(%eax)
  p->state = SLEEPING;
80103f63:	c7 40 10 02 00 00 00 	movl   $0x2,0x10(%eax)
  sched();
80103f6a:	e8 51 fd ff ff       	call   80103cc0 <sched>
  p->chan = 0;
...
80103f81:	68 ba 76 10 80       	push   $0x801076ba
80103f86:	e8 05 c4 ff ff       	call   80100390 <panic>
    panic("sleep");
80103f8b:	83 ec 0c             	sub    $0xc,%esp
80103f8e:	68 b4 76 10 80       	push   $0x801076b4
...
80103fa8:	53                   	push   %ebx
  struct proc *curproc = myproc();
80103fa9:	e8 b2 f9 ff ff       	call   80103960 <myproc>
  acquire(&ptable.lock);
...
80103fb6:	89 c6                	mov    %eax,%esi
  acquire(&ptable.lock);
80103fb8:	e8 53 05 00 00       	call   80104510 <acquire>
80103fbd:	83 c4 10             	add    $0x10,%esp
    havekids = 0;
80103fc0:	31 c0                	xor    %eax,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103fc2:	bb 54 2d 11 80       	mov    $0x80112d54,%ebx
80103fc7:	eb 12                	jmp    80103fdb <wait+0x3b>
...
80103fd9:	74 1b                	je     80103ff6 <wait+0x56>
      if(p->parent != curproc)
80103fdb:	39 73 18             	cmp    %esi,0x18(%ebx)
80103fde:	75 f0                	jne    80103fd0 <wait+0x30>
      if(p->state == ZOMBIE){
80103fe0:	83 7b 10 05          	cmpl   $0x5,0x10(%ebx)
80103fe4:	74 32                	je     80104018 <wait+0x78>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103fe6:	83 eb 80             	sub    $0xffffff80,%ebx
      havekids = 1;
80103fe9:	b8 01 00 00 00       	mov    $0x1,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103fee:	81 fb 54 4d 11 80    	cmp    $0x80114d54,%ebx
80103ff4:	75 e5                	jne    80103fdb <wait+0x3b>
    if(!havekids || curproc->killed){
80103ff6:	85 c0                	test   %eax,%eax
80103ff8:	74 74                	je     8010406e <wait+0xce>
80103ffa:	8b 46 28             	mov    0x28(%esi),%eax
80103ffd:	85 c0                	test   %eax,%eax
80103fff:	75 6d                	jne    8010406e <wait+0xce>
    sleep(curproc, &ptable.lock);  //DOC: wait-sleep
80104001:	83 ec 08             	sub    $0x8,%esp
80104004:	68 20 2d 11 80       	push   $0x80112d20
80104009:	56                   	push   %esi
8010400a:	e8 d1 fe ff ff       	call   80103ee0 <sleep>
    havekids = 0;
8010400f:	83 c4 10             	add    $0x10,%esp
80104012:	eb ac                	jmp    80103fc0 <wait+0x20>
80104014:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
        kfree(p->kstack);
80104018:	83 ec 0c             	sub    $0xc,%esp
8010401b:	ff 73 0c             	pushl  0xc(%ebx)
        pid = p->pid;
8010401e:	8b 73 14             	mov    0x14(%ebx),%esi
        kfree(p->kstack);
80104021:	e8 4a e4 ff ff       	call   80102470 <kfree>
        freevm(p->pgdir);
80104026:	5a                   	pop    %edx
80104027:	ff 73 08             	pushl  0x8(%ebx)
        p->kstack = 0;
8010402a:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        freevm(p->pgdir);
80104031:	e8 8a 2d 00 00       	call   80106dc0 <freevm>
        release(&ptable.lock);
80104036:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
        p->pid = 0;
8010403d:	c7 43 14 00 00 00 00 	movl   $0x0,0x14(%ebx)
        p->parent = 0;
80104044:	c7 43 18 00 00 00 00 	movl   $0x0,0x18(%ebx)
        p->name[0] = 0;
8010404b:	c6 43 70 00          	movb   $0x0,0x70(%ebx)
        p->killed = 0;
...
801040b8:	83 e8 80             	sub    $0xffffff80,%eax
801040bb:	3d 54 4d 11 80       	cmp    $0x80114d54,%eax
801040c0:	74 1c                	je     801040de <wakeup+0x4e>
    if(p->state == SLEEPING && p->chan == chan)
801040c2:	83 78 10 02          	cmpl   $0x2,0x10(%eax)
801040c6:	75 f0                	jne    801040b8 <wakeup+0x28>
801040c8:	3b 58 24             	cmp    0x24(%eax),%ebx
801040cb:	75 eb                	jne    801040b8 <wakeup+0x28>
      p->state = RUNNABLE;
801040cd:	c7 40 10 03 00 00 00 	movl   $0x3,0x10(%eax)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
801040d4:	83 e8 80             	sub    $0xffffff80,%eax
801040d7:	3d 54 4d 11 80       	cmp    $0x80114d54,%eax
...
80104120:	74 36                	je     80104158 <kill+0x68>
    if(p->pid == pid){
80104122:	39 58 14             	cmp    %ebx,0x14(%eax)
80104125:	75 f1                	jne    80104118 <kill+0x28>
      p->killed = 1;
      // Wake process from sleep if necessary.
      if(p->state == SLEEPING)
80104127:	83 78 10 02          	cmpl   $0x2,0x10(%eax)
      p->killed = 1;
8010412b:	c7 40 28 01 00 00 00 	movl   $0x1,0x28(%eax)
      if(p->state == SLEEPING)
80104132:	75 07                	jne    8010413b <kill+0x4b>
        p->state = RUNNABLE;
80104134:	c7 40 10 03 00 00 00 	movl   $0x3,0x10(%eax)
      release(&ptable.lock);
...
8010418d:	bb c4 2d 11 80       	mov    $0x80112dc4,%ebx
...
801041a3:	68 3b 7a 10 80       	push   $0x80107a3b
801041a8:	e8 03 c5 ff ff       	call   801006b0 <cprintf>
801041ad:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801041b0:	83 eb 80             	sub    $0xffffff80,%ebx
801041b3:	81 fb c4 4d 11 80    	cmp    $0x80114dc4,%ebx
...
801041c4:	74 ea                	je     801041b0 <procdump+0x30>
      state = "???";
801041c6:	ba cb 76 10 80       	mov    $0x801076cb,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
801041cb:	83 f8 05             	cmp    $0x5,%eax
801041ce:	77 11                	ja     801041e1 <procdump+0x61>
801041d0:	8b 14 85 2c 77 10 80 	mov    -0x7fef88d4(,%eax,4),%edx
      state = "???";
801041d7:	b8 cb 76 10 80       	mov    $0x801076cb,%eax
...
801041e6:	68 cf 76 10 80       	push   $0x801076cf
...
80104225:	68 21 71 10 80       	push   $0x80107121
...
8010425e:	68 44 77 10 80       	push   $0x80107744
...
801042bd:	e8 1e fc ff ff       	call   80103ee0 <sleep>
  while (lk->locked) {
...
801042cb:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
801042d1:	e8 8a f6 ff ff       	call   80103960 <myproc>
801042d6:	8b 40 14             	mov    0x14(%eax),%eax
...
80104373:	e8 e8 f5 ff ff       	call   80103960 <myproc>
80104378:	39 58 14             	cmp    %ebx,0x14(%eax)
...
8010442b:	74 13                	je     80104440 <pushcli+0x30>
  ...
  mycpu()->ncli += 1;
8010442d:	e8 9e f4 ff ff       	call   801038d0 <mycpu>
...
8010443f:	90                   	nop
    mycpu()->intena = eflags & FL_IF;
80104440:	e8 8b f4 ff ff       	call   801038d0 <mycpu>
...
8010446f:	75 31                	jne    801044a2 <popcli+0x42>
  ...
  if(--mycpu()->ncli < 0)
80104471:	e8 5a f4 ff ff       	call   801038d0 <mycpu>
...
801044a5:	68 4f 77 10 80       	push   $0x8010774f
801044aa:	e8 e1 be ff ff       	call   80100390 <panic>
    panic("popcli");
801044af:	83 ec 0c             	sub    $0xc,%esp
801044b2:	68 66 77 10 80       	push   $0x80107766
...
801044eb:	e8 e0 f3 ff ff       	call   801038d0 <mycpu>
...
80104554:	e8 77 f3 ff ff       	call   801038d0 <mycpu>
...
801045b7:	68 6d 77 10 80       	push   $0x8010776d
...
80104610:	68 75 77 10 80       	push   $0x80107775
...
8010486b:	8b 5d 08             	mov    0x8(%ebp),%ebx
  struct proc *curproc = myproc();
8010486e:	e8 ed f0 ff ff       	call   80103960 <myproc>

  if(addr >= curproc->sz || addr+4 > curproc->sz)
80104873:	8b 40 04             	mov    0x4(%eax),%eax
80104876:	39 d8                	cmp    %ebx,%eax
80104878:	76 16                	jbe    80104890 <fetchint+0x30>
8010487a:	8d 53 04             	lea    0x4(%ebx),%edx
8010487d:	39 d0                	cmp    %edx,%eax
8010487f:	72 0f                	jb     80104890 <fetchint+0x30>
    return -1;
  *ip = *(int*)(addr);
80104881:	8b 45 0c             	mov    0xc(%ebp),%eax
80104884:	8b 13                	mov    (%ebx),%edx
80104886:	89 10                	mov    %edx,(%eax)
  return 0;
80104888:	31 c0                	xor    %eax,%eax
}
8010488a:	83 c4 04             	add    $0x4,%esp
8010488d:	5b                   	pop    %ebx
8010488e:	5d                   	pop    %ebp
8010488f:	c3                   	ret    
    return -1;
80104890:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104895:	eb f3                	jmp    8010488a <fetchint+0x2a>
...
801048ab:	8b 5d 08             	mov    0x8(%ebp),%ebx
  char *s, *ep;
  struct proc *curproc = myproc();
801048ae:	e8 ad f0 ff ff       	call   80103960 <myproc>

  if(addr >= curproc->sz)
801048b3:	39 58 04             	cmp    %ebx,0x4(%eax)
801048b6:	76 30                	jbe    801048e8 <fetchstr+0x48>
    return -1;
  *pp = (char*)addr;
801048b8:	8b 55 0c             	mov    0xc(%ebp),%edx
801048bb:	89 1a                	mov    %ebx,(%edx)
  ep = (char*)curproc->sz;
801048bd:	8b 50 04             	mov    0x4(%eax),%edx
  for(s = *pp; s < ep; s++){
801048c0:	39 d3                	cmp    %edx,%ebx
801048c2:	73 24                	jae    801048e8 <fetchstr+0x48>
801048c4:	89 d8                	mov    %ebx,%eax
801048c6:	eb 0f                	jmp    801048d7 <fetchstr+0x37>
...
80104909:	e8 52 f0 ff ff       	call   80103960 <myproc>
...
80104917:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
8010491a:	e8 41 f0 ff ff       	call   80103960 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
8010491f:	8d 73 04             	lea    0x4(%ebx),%esi
  if(addr >= curproc->sz || addr+4 > curproc->sz)
80104922:	8b 40 04             	mov    0x4(%eax),%eax
80104925:	39 c6                	cmp    %eax,%esi
80104927:	73 17                	jae    80104940 <argint+0x40>
80104929:	8d 53 08             	lea    0x8(%ebx),%edx
8010492c:	39 d0                	cmp    %edx,%eax
8010492e:	72 10                	jb     80104940 <argint+0x40>
  *ip = *(int*)(addr);
80104930:	8b 45 0c             	mov    0xc(%ebp),%eax
80104933:	8b 53 04             	mov    0x4(%ebx),%edx
80104936:	89 10                	mov    %edx,(%eax)
  return 0;
...
80104940:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
80104945:	eb f3                	jmp    8010493a <argint+0x3a>
...
8010495c:	8b 5d 10             	mov    0x10(%ebp),%ebx
  int i;
  struct proc *curproc = myproc();
8010495f:	e8 fc ef ff ff       	call   80103960 <myproc>
...
80104980:	8b 56 04             	mov    0x4(%esi),%edx
80104983:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104986:	39 c2                	cmp    %eax,%edx
80104988:	76 16                	jbe    801049a0 <argptr+0x50>
8010498a:	01 c3                	add    %eax,%ebx
8010498c:	39 da                	cmp    %ebx,%edx
8010498e:	72 10                	jb     801049a0 <argptr+0x50>
    return -1;
  *pp = (char*)i;
80104990:	8b 55 0c             	mov    0xc(%ebp),%edx
80104993:	89 02                	mov    %eax,(%edx)
  return 0;
...
801049a5:	eb f0                	jmp    80104997 <argptr+0x47>
...
801049f8:	83 ec 04             	sub    $0x4,%esp
  int num;
  struct proc *curproc = myproc();
801049fb:	e8 60 ef ff ff       	call   80103960 <myproc>
...
80104a0b:	74 53                	je     80104a60 <syscall+0x70>
    curproc->readid = curproc->readid + 1; //added part
  }
  
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
80104a0d:	8d 50 ff             	lea    -0x1(%eax),%edx
80104a10:	83 fa 15             	cmp    $0x15,%edx
80104a13:	76 2b                	jbe    80104a40 <syscall+0x50>
    curproc->tf->eax = syscalls[num]();
  } else {
    cprintf("%d %s: unknown sys call %d\n",
80104a15:	50                   	push   %eax
            curproc->pid, curproc->name, num);
80104a16:	8d 43 70             	lea    0x70(%ebx),%eax
    cprintf("%d %s: unknown sys call %d\n",
80104a19:	50                   	push   %eax
80104a1a:	ff 73 14             	pushl  0x14(%ebx)
80104a1d:	68 7d 77 10 80       	push   $0x8010777d
80104a22:	e8 89 bc ff ff       	call   801006b0 <cprintf>
    curproc->tf->eax = -1;
80104a27:	8b 43 1c             	mov    0x1c(%ebx),%eax
80104a2a:	83 c4 10             	add    $0x10,%esp
80104a2d:	c7 40 1c ff ff ff ff 	movl   $0xffffffff,0x1c(%eax)
  }
}
...
80104a39:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
80104a40:	8b 14 85 a0 77 10 80 	mov    -0x7fef8860(,%eax,4),%edx
80104a47:	85 d2                	test   %edx,%edx
80104a49:	74 ca                	je     80104a15 <syscall+0x25>
    curproc->tf->eax = syscalls[num]();
80104a4b:	ff d2                	call   *%edx
80104a4d:	89 c2                	mov    %eax,%edx
80104a4f:	8b 43 1c             	mov    0x1c(%ebx),%eax
...
80104a5a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
80104a60:	ba e0 4c 10 80       	mov    $0x80104ce0,%edx
    curproc->readid = curproc->readid + 1; //added part
80104a65:	83 03 01             	addl   $0x1,(%ebx)
    curproc->tf->eax = syscalls[num]();
80104a68:	ff d2                	call   *%edx
80104a6a:	89 c2                	mov    %eax,%edx
80104a6c:	8b 43 1c             	mov    0x1c(%ebx),%eax
80104a6f:	89 50 1c             	mov    %edx,0x1c(%eax)
80104a72:	eb e1                	jmp    80104a55 <syscall+0x65>
...
80104a85:	8d 7d da             	lea    -0x26(%ebp),%edi
{
...
80104a97:	89 4d cc             	mov    %ecx,-0x34(%ebp)
  if((dp = nameiparent(path, name)) == 0)
80104a9a:	e8 b1 d5 ff ff       	call   80102050 <nameiparent>
...
80104ab0:	e8 ab cc ff ff       	call   80101760 <ilock>

  if((ip = dirlookup(dp, name, 0)) != 0){
80104ab5:	83 c4 0c             	add    $0xc,%esp
80104ab8:	6a 00                	push   $0x0
80104aba:	57                   	push   %edi
80104abb:	53                   	push   %ebx
80104abc:	e8 ef d1 ff ff       	call   80101cb0 <dirlookup>
80104ac1:	83 c4 10             	add    $0x10,%esp
80104ac4:	89 c6                	mov    %eax,%esi
80104ac6:	85 c0                	test   %eax,%eax
80104ac8:	74 56                	je     80104b20 <create+0xa0>
    iunlockput(dp);
80104aca:	83 ec 0c             	sub    $0xc,%esp
80104acd:	53                   	push   %ebx
80104ace:	e8 2d cf ff ff       	call   80101a00 <iunlockput>
    ilock(ip);
80104ad3:	89 34 24             	mov    %esi,(%esp)
80104ad6:	e8 85 cc ff ff       	call   80101760 <ilock>
    if(type == T_FILE && ip->type == T_FILE)
80104adb:	83 c4 10             	add    $0x10,%esp
80104ade:	66 83 7d d4 02       	cmpw   $0x2,-0x2c(%ebp)
80104ae3:	75 1b                	jne    80104b00 <create+0x80>
80104ae5:	66 83 7e 50 02       	cmpw   $0x2,0x50(%esi)
80104aea:	75 14                	jne    80104b00 <create+0x80>
...
80104b04:	31 f6                	xor    %esi,%esi
    iunlockput(ip);
80104b06:	e8 f5 ce ff ff       	call   80101a00 <iunlockput>
    return 0;
...
80104b49:	66 89 46 52          	mov    %ax,0x52(%esi)
  ip->minor = minor;
80104b4d:	0f b7 45 cc          	movzwl -0x34(%ebp),%eax
80104b51:	66 89 46 54          	mov    %ax,0x54(%esi)
  ip->nlink = 1;
80104b55:	b8 01 00 00 00       	mov    $0x1,%eax
80104b5a:	66 89 46 56          	mov    %ax,0x56(%esi)
  iupdate(ip);
...
80104b73:	ff 76 04             	pushl  0x4(%esi)
80104b76:	57                   	push   %edi
80104b77:	53                   	push   %ebx
80104b78:	e8 f3 d3 ff ff       	call   80101f70 <dirlink>
...
80104b88:	e8 73 ce ff ff       	call   80101a00 <iunlockput>
  return ip;
80104b8d:	83 c4 10             	add    $0x10,%esp
}
80104b90:	8d 65 f4             	lea    -0xc(%ebp),%esp
80104b93:	89 f0                	mov    %esi,%eax
80104b95:	5b                   	pop    %ebx
80104b96:	5e                   	pop    %esi
80104b97:	5f                   	pop    %edi
80104b98:	5d                   	pop    %ebp
...
80104ba0:	83 ec 0c             	sub    $0xc,%esp
    dp->nlink++;  // for ".."
80104ba3:	66 83 43 56 01       	addw   $0x1,0x56(%ebx)
    iupdate(dp);
80104ba8:	53                   	push   %ebx
80104ba9:	e8 f2 ca ff ff       	call   801016a0 <iupdate>
    if(dirlink(ip, ".", ip->inum) < 0 || dirlink(ip, "..", dp->inum) < 0)
80104bae:	83 c4 0c             	add    $0xc,%esp
80104bb1:	ff 76 04             	pushl  0x4(%esi)
80104bb4:	68 18 78 10 80       	push   $0x80107818
80104bb9:	56                   	push   %esi
80104bba:	e8 b1 d3 ff ff       	call   80101f70 <dirlink>
...
80104bcc:	68 17 78 10 80       	push   $0x80107817
80104bd1:	56                   	push   %esi
80104bd2:	e8 99 d3 ff ff       	call   80101f70 <dirlink>
...
80104be1:	68 0b 78 10 80       	push   $0x8010780b
...
80104bf0:	8d 65 f4             	lea    -0xc(%ebp),%esp
    return 0;
80104bf3:	31 f6                	xor    %esi,%esi
}
80104bf5:	5b                   	pop    %ebx
80104bf6:	89 f0                	mov    %esi,%eax
80104bf8:	5e                   	pop    %esi
80104bf9:	5f                   	pop    %edi
80104bfa:	5d                   	pop    %ebp
80104bfb:	c3                   	ret    
...
80104bff:	68 1a 78 10 80       	push   $0x8010781a
80104c04:	e8 87 b7 ff ff       	call   80100390 <panic>
    panic("create: ialloc");
80104c09:	83 ec 0c             	sub    $0xc,%esp
80104c0c:	68 fc 77 10 80       	push   $0x801077fc
...
80104c44:	e8 17 ed ff ff       	call   80103960 <myproc>
80104c49:	8b 55 f4             	mov    -0xc(%ebp),%edx
80104c4c:	8b 44 90 2c          	mov    0x2c(%eax,%edx,4),%eax
...
80104c7a:	53                   	push   %ebx
  if(argfd(0, 0, &f) < 0)
80104c7b:	8d 55 f4             	lea    -0xc(%ebp),%edx
{
80104c7e:	83 ec 10             	sub    $0x10,%esp
  if(argfd(0, 0, &f) < 0)
80104c81:	e8 9a ff ff ff       	call   80104c20 <argfd.constprop.0>
80104c86:	85 c0                	test   %eax,%eax
80104c88:	78 1e                	js     80104ca8 <sys_dup+0x38>
  if((fd=fdalloc(f)) < 0)
80104c8a:	8b 75 f4             	mov    -0xc(%ebp),%esi
  for(fd = 0; fd < NOFILE; fd++){
80104c8d:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
80104c8f:	e8 cc ec ff ff       	call   80103960 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
80104c94:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    if(curproc->ofile[fd] == 0){
80104c98:	8b 54 98 2c          	mov    0x2c(%eax,%ebx,4),%edx
80104c9c:	85 d2                	test   %edx,%edx
80104c9e:	74 20                	je     80104cc0 <sys_dup+0x50>
  for(fd = 0; fd < NOFILE; fd++){
80104ca0:	83 c3 01             	add    $0x1,%ebx
80104ca3:	83 fb 10             	cmp    $0x10,%ebx
...
80104cbd:	8d 76 00             	lea    0x0(%esi),%esi
      curproc->ofile[fd] = f;
80104cc0:	89 74 98 2c          	mov    %esi,0x2c(%eax,%ebx,4)
  filedup(f);
80104cc4:	83 ec 0c             	sub    $0xc,%esp
80104cc7:	ff 75 f4             	pushl  -0xc(%ebp)
80104cca:	e8 a1 c1 ff ff       	call   80100e70 <filedup>
  return fd;
...
80104ce9:	83 ec 18             	sub    $0x18,%esp
  if(argfd(0, 0, &f) < 0 || argint(2, &n) < 0 || argptr(1, &p, n) < 0)
80104cec:	8d 55 ec             	lea    -0x14(%ebp),%edx
80104cef:	e8 2c ff ff ff       	call   80104c20 <argfd.constprop.0>
80104cf4:	85 c0                	test   %eax,%eax
80104cf6:	78 48                	js     80104d40 <sys_read+0x60>
80104cf8:	83 ec 08             	sub    $0x8,%esp
80104cfb:	8d 45 f0             	lea    -0x10(%ebp),%eax
80104cfe:	50                   	push   %eax
80104cff:	6a 02                	push   $0x2
80104d01:	e8 fa fb ff ff       	call   80104900 <argint>
80104d06:	83 c4 10             	add    $0x10,%esp
80104d09:	85 c0                	test   %eax,%eax
80104d0b:	78 33                	js     80104d40 <sys_read+0x60>
80104d0d:	83 ec 04             	sub    $0x4,%esp
80104d10:	8d 45 f4             	lea    -0xc(%ebp),%eax
80104d13:	ff 75 f0             	pushl  -0x10(%ebp)
80104d16:	50                   	push   %eax
80104d17:	6a 01                	push   $0x1
80104d19:	e8 32 fc ff ff       	call   80104950 <argptr>
80104d1e:	83 c4 10             	add    $0x10,%esp
80104d21:	85 c0                	test   %eax,%eax
80104d23:	78 1b                	js     80104d40 <sys_read+0x60>
  return fileread(f, p, n);
80104d25:	83 ec 04             	sub    $0x4,%esp
80104d28:	ff 75 f0             	pushl  -0x10(%ebp)
80104d2b:	ff 75 f4             	pushl  -0xc(%ebp)
80104d2e:	ff 75 ec             	pushl  -0x14(%ebp)
80104d31:	e8 ba c2 ff ff       	call   80100ff0 <fileread>
...
80104d59:	83 ec 18             	sub    $0x18,%esp
  if(argfd(0, 0, &f) < 0 || argint(2, &n) < 0 || argptr(1, &p, n) < 0)
80104d5c:	8d 55 ec             	lea    -0x14(%ebp),%edx
80104d5f:	e8 bc fe ff ff       	call   80104c20 <argfd.constprop.0>
80104d64:	85 c0                	test   %eax,%eax
80104d66:	78 48                	js     80104db0 <sys_write+0x60>
80104d68:	83 ec 08             	sub    $0x8,%esp
80104d6b:	8d 45 f0             	lea    -0x10(%ebp),%eax
80104d6e:	50                   	push   %eax
80104d6f:	6a 02                	push   $0x2
80104d71:	e8 8a fb ff ff       	call   80104900 <argint>
80104d76:	83 c4 10             	add    $0x10,%esp
80104d79:	85 c0                	test   %eax,%eax
80104d7b:	78 33                	js     80104db0 <sys_write+0x60>
80104d7d:	83 ec 04             	sub    $0x4,%esp
80104d80:	8d 45 f4             	lea    -0xc(%ebp),%eax
80104d83:	ff 75 f0             	pushl  -0x10(%ebp)
80104d86:	50                   	push   %eax
80104d87:	6a 01                	push   $0x1
80104d89:	e8 c2 fb ff ff       	call   80104950 <argptr>
80104d8e:	83 c4 10             	add    $0x10,%esp
80104d91:	85 c0                	test   %eax,%eax
80104d93:	78 1b                	js     80104db0 <sys_write+0x60>
  return filewrite(f, p, n);
80104d95:	83 ec 04             	sub    $0x4,%esp
80104d98:	ff 75 f0             	pushl  -0x10(%ebp)
80104d9b:	ff 75 f4             	pushl  -0xc(%ebp)
80104d9e:	ff 75 ec             	pushl  -0x14(%ebp)
80104da1:	e8 ea c2 ff ff       	call   80101090 <filewrite>
...
80104dc7:	83 ec 18             	sub    $0x18,%esp
  if(argfd(0, &fd, &f) < 0)
80104dca:	8d 55 f4             	lea    -0xc(%ebp),%edx
80104dcd:	8d 45 f0             	lea    -0x10(%ebp),%eax
80104dd0:	e8 4b fe ff ff       	call   80104c20 <argfd.constprop.0>
80104dd5:	85 c0                	test   %eax,%eax
80104dd7:	78 27                	js     80104e00 <sys_close+0x40>
  myproc()->ofile[fd] = 0;
80104dd9:	e8 82 eb ff ff       	call   80103960 <myproc>
80104dde:	8b 55 f0             	mov    -0x10(%ebp),%edx
  fileclose(f);
80104de1:	83 ec 0c             	sub    $0xc,%esp
  myproc()->ofile[fd] = 0;
80104de4:	c7 44 90 2c 00 00 00 	movl   $0x0,0x2c(%eax,%edx,4)
80104deb:	00 
  fileclose(f);
80104dec:	ff 75 f4             	pushl  -0xc(%ebp)
80104def:	e8 cc c0 ff ff       	call   80100ec0 <fileclose>
  return 0;
80104df4:	83 c4 10             	add    $0x10,%esp
80104df7:	31 c0                	xor    %eax,%eax
}
80104df9:	c9                   	leave  
80104dfa:	c3                   	ret    
...
80104e19:	83 ec 18             	sub    $0x18,%esp
  if(argfd(0, 0, &f) < 0 || argptr(1, (void*)&st, sizeof(*st)) < 0)
80104e1c:	8d 55 f0             	lea    -0x10(%ebp),%edx
80104e1f:	e8 fc fd ff ff       	call   80104c20 <argfd.constprop.0>
80104e24:	85 c0                	test   %eax,%eax
80104e26:	78 30                	js     80104e58 <sys_fstat+0x48>
80104e28:	83 ec 04             	sub    $0x4,%esp
80104e2b:	8d 45 f4             	lea    -0xc(%ebp),%eax
80104e2e:	6a 14                	push   $0x14
80104e30:	50                   	push   %eax
80104e31:	6a 01                	push   $0x1
80104e33:	e8 18 fb ff ff       	call   80104950 <argptr>
80104e38:	83 c4 10             	add    $0x10,%esp
80104e3b:	85 c0                	test   %eax,%eax
80104e3d:	78 19                	js     80104e58 <sys_fstat+0x48>
  return filestat(f, st);
80104e3f:	83 ec 08             	sub    $0x8,%esp
80104e42:	ff 75 f4             	pushl  -0xc(%ebp)
80104e45:	ff 75 f0             	pushl  -0x10(%ebp)
80104e48:	e8 53 c1 ff ff       	call   80100fa0 <filestat>
...
80104e6d:	83 ec 34             	sub    $0x34,%esp
  if(argstr(0, &old) < 0 || argstr(1, &new) < 0)
80104e70:	50                   	push   %eax
80104e71:	6a 00                	push   $0x0
80104e73:	e8 38 fb ff ff       	call   801049b0 <argstr>
80104e78:	83 c4 10             	add    $0x10,%esp
80104e7b:	85 c0                	test   %eax,%eax
80104e7d:	0f 88 ff 00 00 00    	js     80104f82 <sys_link+0x122>
80104e83:	83 ec 08             	sub    $0x8,%esp
80104e86:	8d 45 d0             	lea    -0x30(%ebp),%eax
80104e89:	50                   	push   %eax
80104e8a:	6a 01                	push   $0x1
80104e8c:	e8 1f fb ff ff       	call   801049b0 <argstr>
80104e91:	83 c4 10             	add    $0x10,%esp
80104e94:	85 c0                	test   %eax,%eax
80104e96:	0f 88 e6 00 00 00    	js     80104f82 <sys_link+0x122>
  begin_op();
80104e9c:	e8 8f de ff ff       	call   80102d30 <begin_op>
  if((ip = namei(old)) == 0){
80104ea1:	83 ec 0c             	sub    $0xc,%esp
80104ea4:	ff 75 d4             	pushl  -0x2c(%ebp)
80104ea7:	e8 84 d1 ff ff       	call   80102030 <namei>
80104eac:	83 c4 10             	add    $0x10,%esp
80104eaf:	89 c3                	mov    %eax,%ebx
80104eb1:	85 c0                	test   %eax,%eax
80104eb3:	0f 84 e8 00 00 00    	je     80104fa1 <sys_link+0x141>
  ilock(ip);
80104eb9:	83 ec 0c             	sub    $0xc,%esp
80104ebc:	50                   	push   %eax
80104ebd:	e8 9e c8 ff ff       	call   80101760 <ilock>
  if(ip->type == T_DIR){
80104ec2:	83 c4 10             	add    $0x10,%esp
80104ec5:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
80104eca:	0f 84 b9 00 00 00    	je     80104f89 <sys_link+0x129>
  iupdate(ip);
80104ed0:	83 ec 0c             	sub    $0xc,%esp
  ip->nlink++;
80104ed3:	66 83 43 56 01       	addw   $0x1,0x56(%ebx)
  if((dp = nameiparent(new, name)) == 0)
80104ed8:	8d 7d da             	lea    -0x26(%ebp),%edi
  iupdate(ip);
80104edb:	53                   	push   %ebx
80104edc:	e8 bf c7 ff ff       	call   801016a0 <iupdate>
  iunlock(ip);
80104ee1:	89 1c 24             	mov    %ebx,(%esp)
80104ee4:	e8 57 c9 ff ff       	call   80101840 <iunlock>
  if((dp = nameiparent(new, name)) == 0)
80104ee9:	58                   	pop    %eax
80104eea:	5a                   	pop    %edx
80104eeb:	57                   	push   %edi
80104eec:	ff 75 d0             	pushl  -0x30(%ebp)
80104eef:	e8 5c d1 ff ff       	call   80102050 <nameiparent>
80104ef4:	83 c4 10             	add    $0x10,%esp
80104ef7:	89 c6                	mov    %eax,%esi
80104ef9:	85 c0                	test   %eax,%eax
80104efb:	74 5f                	je     80104f5c <sys_link+0xfc>
  ilock(dp);
80104efd:	83 ec 0c             	sub    $0xc,%esp
80104f00:	50                   	push   %eax
80104f01:	e8 5a c8 ff ff       	call   80101760 <ilock>
  if(dp->dev != ip->dev || dirlink(dp, name, ip->inum) < 0){
80104f06:	8b 03                	mov    (%ebx),%eax
80104f08:	83 c4 10             	add    $0x10,%esp
80104f0b:	39 06                	cmp    %eax,(%esi)
80104f0d:	75 41                	jne    80104f50 <sys_link+0xf0>
80104f0f:	83 ec 04             	sub    $0x4,%esp
80104f12:	ff 73 04             	pushl  0x4(%ebx)
80104f15:	57                   	push   %edi
80104f16:	56                   	push   %esi
80104f17:	e8 54 d0 ff ff       	call   80101f70 <dirlink>
80104f1c:	83 c4 10             	add    $0x10,%esp
80104f1f:	85 c0                	test   %eax,%eax
80104f21:	78 2d                	js     80104f50 <sys_link+0xf0>
  iunlockput(dp);
80104f23:	83 ec 0c             	sub    $0xc,%esp
80104f26:	56                   	push   %esi
80104f27:	e8 d4 ca ff ff       	call   80101a00 <iunlockput>
  iput(ip);
80104f2c:	89 1c 24             	mov    %ebx,(%esp)
80104f2f:	e8 5c c9 ff ff       	call   80101890 <iput>
  end_op();
80104f34:	e8 67 de ff ff       	call   80102da0 <end_op>
  return 0;
...
80104f54:	e8 a7 ca ff ff       	call   80101a00 <iunlockput>
    goto bad;
...
80104f60:	e8 fb c7 ff ff       	call   80101760 <ilock>
  ip->nlink--;
80104f65:	66 83 6b 56 01       	subw   $0x1,0x56(%ebx)
  iupdate(ip);
80104f6a:	89 1c 24             	mov    %ebx,(%esp)
80104f6d:	e8 2e c7 ff ff       	call   801016a0 <iupdate>
  iunlockput(ip);
80104f72:	89 1c 24             	mov    %ebx,(%esp)
80104f75:	e8 86 ca ff ff       	call   80101a00 <iunlockput>
  end_op();
80104f7a:	e8 21 de ff ff       	call   80102da0 <end_op>
  return -1;
80104f7f:	83 c4 10             	add    $0x10,%esp
80104f82:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104f87:	eb b5                	jmp    80104f3e <sys_link+0xde>
    iunlockput(ip);
80104f89:	83 ec 0c             	sub    $0xc,%esp
80104f8c:	53                   	push   %ebx
80104f8d:	e8 6e ca ff ff       	call   80101a00 <iunlockput>
    end_op();
80104f92:	e8 09 de ff ff       	call   80102da0 <end_op>
    return -1;
80104f97:	83 c4 10             	add    $0x10,%esp
80104f9a:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104f9f:	eb 9d                	jmp    80104f3e <sys_link+0xde>
    end_op();
80104fa1:	e8 fa dd ff ff       	call   80102da0 <end_op>
    return -1;
80104fa6:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104fab:	eb 91                	jmp    80104f3e <sys_link+0xde>
...
80104fb8:	56                   	push   %esi
  if(argstr(0, &path) < 0)
80104fb9:	8d 45 c0             	lea    -0x40(%ebp),%eax
{
80104fbc:	53                   	push   %ebx
80104fbd:	83 ec 54             	sub    $0x54,%esp
  if(argstr(0, &path) < 0)
80104fc0:	50                   	push   %eax
80104fc1:	6a 00                	push   $0x0
80104fc3:	e8 e8 f9 ff ff       	call   801049b0 <argstr>
80104fc8:	83 c4 10             	add    $0x10,%esp
80104fcb:	85 c0                	test   %eax,%eax
80104fcd:	0f 88 7d 01 00 00    	js     80105150 <sys_unlink+0x1a0>
  begin_op();
80104fd3:	e8 58 dd ff ff       	call   80102d30 <begin_op>
  if((dp = nameiparent(path, name)) == 0){
80104fd8:	8d 5d ca             	lea    -0x36(%ebp),%ebx
80104fdb:	83 ec 08             	sub    $0x8,%esp
80104fde:	53                   	push   %ebx
80104fdf:	ff 75 c0             	pushl  -0x40(%ebp)
80104fe2:	e8 69 d0 ff ff       	call   80102050 <nameiparent>
80104fe7:	83 c4 10             	add    $0x10,%esp
80104fea:	89 c6                	mov    %eax,%esi
80104fec:	85 c0                	test   %eax,%eax
80104fee:	0f 84 66 01 00 00    	je     8010515a <sys_unlink+0x1aa>
  ilock(dp);
80104ff4:	83 ec 0c             	sub    $0xc,%esp
80104ff7:	50                   	push   %eax
80104ff8:	e8 63 c7 ff ff       	call   80101760 <ilock>
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
80104ffd:	58                   	pop    %eax
80104ffe:	5a                   	pop    %edx
80104fff:	68 18 78 10 80       	push   $0x80107818
80105004:	53                   	push   %ebx
80105005:	e8 86 cc ff ff       	call   80101c90 <namecmp>
8010500a:	83 c4 10             	add    $0x10,%esp
8010500d:	85 c0                	test   %eax,%eax
8010500f:	0f 84 03 01 00 00    	je     80105118 <sys_unlink+0x168>
80105015:	83 ec 08             	sub    $0x8,%esp
80105018:	68 17 78 10 80       	push   $0x80107817
8010501d:	53                   	push   %ebx
8010501e:	e8 6d cc ff ff       	call   80101c90 <namecmp>
80105023:	83 c4 10             	add    $0x10,%esp
80105026:	85 c0                	test   %eax,%eax
80105028:	0f 84 ea 00 00 00    	je     80105118 <sys_unlink+0x168>
  if((ip = dirlookup(dp, name, &off)) == 0)
8010502e:	83 ec 04             	sub    $0x4,%esp
80105031:	8d 45 c4             	lea    -0x3c(%ebp),%eax
80105034:	50                   	push   %eax
80105035:	53                   	push   %ebx
80105036:	56                   	push   %esi
80105037:	e8 74 cc ff ff       	call   80101cb0 <dirlookup>
8010503c:	83 c4 10             	add    $0x10,%esp
8010503f:	89 c3                	mov    %eax,%ebx
80105041:	85 c0                	test   %eax,%eax
80105043:	0f 84 cf 00 00 00    	je     80105118 <sys_unlink+0x168>
  ilock(ip);
...
8010505a:	0f 8e 23 01 00 00    	jle    80105183 <sys_unlink+0x1d3>
  if(ip->type == T_DIR && !isdirempty(ip)){
80105060:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
80105065:	8d 7d d8             	lea    -0x28(%ebp),%edi
...
80105072:	e8 a9 f5 ff ff       	call   80104620 <memset>
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
80105077:	6a 10                	push   $0x10
80105079:	ff 75 c4             	pushl  -0x3c(%ebp)
8010507c:	57                   	push   %edi
8010507d:	56                   	push   %esi
8010507e:	e8 dd ca ff ff       	call   80101b60 <writei>
80105083:	83 c4 20             	add    $0x20,%esp
80105086:	83 f8 10             	cmp    $0x10,%eax
80105089:	0f 85 e7 00 00 00    	jne    80105176 <sys_unlink+0x1c6>
  if(ip->type == T_DIR){
8010508f:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
80105094:	0f 84 96 00 00 00    	je     80105130 <sys_unlink+0x180>
  iunlockput(dp);
8010509a:	83 ec 0c             	sub    $0xc,%esp
8010509d:	56                   	push   %esi
8010509e:	e8 5d c9 ff ff       	call   80101a00 <iunlockput>
  ip->nlink--;
801050a3:	66 83 6b 56 01       	subw   $0x1,0x56(%ebx)
  iupdate(ip);
801050a8:	89 1c 24             	mov    %ebx,(%esp)
801050ab:	e8 f0 c5 ff ff       	call   801016a0 <iupdate>
  iunlockput(ip);
801050b0:	89 1c 24             	mov    %ebx,(%esp)
801050b3:	e8 48 c9 ff ff       	call   80101a00 <iunlockput>
  end_op();
801050b8:	e8 e3 dc ff ff       	call   80102da0 <end_op>
  return 0;
801050bd:	83 c4 10             	add    $0x10,%esp
801050c0:	31 c0                	xor    %eax,%eax
}
801050c2:	8d 65 f4             	lea    -0xc(%ebp),%esp
801050c5:	5b                   	pop    %ebx
801050c6:	5e                   	pop    %esi
801050c7:	5f                   	pop    %edi
801050c8:	5d                   	pop    %ebp
...
801050db:	eb 0b                	jmp    801050e8 <sys_unlink+0x138>
801050dd:	8d 76 00             	lea    0x0(%esi),%esi
801050e0:	83 c2 10             	add    $0x10,%edx
801050e3:	39 53 58             	cmp    %edx,0x58(%ebx)
801050e6:	76 82                	jbe    8010506a <sys_unlink+0xba>
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
801050e8:	6a 10                	push   $0x10
801050ea:	52                   	push   %edx
801050eb:	57                   	push   %edi
801050ec:	53                   	push   %ebx
801050ed:	89 55 b4             	mov    %edx,-0x4c(%ebp)
801050f0:	e8 6b c9 ff ff       	call   80101a60 <readi>
801050f5:	83 c4 10             	add    $0x10,%esp
801050f8:	8b 55 b4             	mov    -0x4c(%ebp),%edx
801050fb:	83 f8 10             	cmp    $0x10,%eax
801050fe:	75 69                	jne    80105169 <sys_unlink+0x1b9>
    if(de.inum != 0)
80105100:	66 83 7d d8 00       	cmpw   $0x0,-0x28(%ebp)
80105105:	74 d9                	je     801050e0 <sys_unlink+0x130>
    iunlockput(ip);
80105107:	83 ec 0c             	sub    $0xc,%esp
8010510a:	53                   	push   %ebx
8010510b:	e8 f0 c8 ff ff       	call   80101a00 <iunlockput>
    goto bad;
...
80105141:	e9 54 ff ff ff       	jmp    8010509a <sys_unlink+0xea>
...
8010519d:	83 ec 24             	sub    $0x24,%esp
  if(argstr(0, &path) < 0 || argint(1, &omode) < 0)
801051a0:	50                   	push   %eax
801051a1:	6a 00                	push   $0x0
801051a3:	e8 08 f8 ff ff       	call   801049b0 <argstr>
801051a8:	83 c4 10             	add    $0x10,%esp
801051ab:	85 c0                	test   %eax,%eax
801051ad:	0f 88 8a 00 00 00    	js     8010523d <sys_open+0xad>
801051b3:	83 ec 08             	sub    $0x8,%esp
801051b6:	8d 45 e4             	lea    -0x1c(%ebp),%eax
801051b9:	50                   	push   %eax
801051ba:	6a 01                	push   $0x1
801051bc:	e8 3f f7 ff ff       	call   80104900 <argint>
801051c1:	83 c4 10             	add    $0x10,%esp
801051c4:	85 c0                	test   %eax,%eax
801051c6:	78 75                	js     8010523d <sys_open+0xad>
    return -1;

  begin_op();
801051c8:	e8 63 db ff ff       	call   80102d30 <begin_op>

  if(omode & O_CREATE){
801051cd:	f6 45 e5 02          	testb  $0x2,-0x1b(%ebp)
801051d1:	75 75                	jne    80105248 <sys_open+0xb8>
    if(ip == 0){
      end_op();
      return -1;
    }
...
801051d6:	ff 75 e0             	pushl  -0x20(%ebp)
801051d9:	e8 52 ce ff ff       	call   80102030 <namei>
801051de:	83 c4 10             	add    $0x10,%esp
801051e1:	89 c6                	mov    %eax,%esi
801051e3:	85 c0                	test   %eax,%eax
801051e5:	74 7e                	je     80105265 <sys_open+0xd5>
      end_op();
      return -1;
    }
    ilock(ip);
...
801051eb:	e8 70 c5 ff ff       	call   80101760 <ilock>
...
801051fe:	e8 fd bb ff ff       	call   80100e00 <filealloc>
80105203:	89 c7                	mov    %eax,%edi
80105205:	85 c0                	test   %eax,%eax
80105207:	74 23                	je     8010522c <sys_open+0x9c>
  struct proc *curproc = myproc();
80105209:	e8 52 e7 ff ff       	call   80103960 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
8010520e:	31 db                	xor    %ebx,%ebx
    if(curproc->ofile[fd] == 0){
80105210:	8b 54 98 2c          	mov    0x2c(%eax,%ebx,4),%edx
...
80105224:	e8 97 bc ff ff       	call   80100ec0 <fileclose>
80105229:	83 c4 10             	add    $0x10,%esp
    iunlockput(ip);
8010522c:	83 ec 0c             	sub    $0xc,%esp
8010522f:	56                   	push   %esi
80105230:	e8 cb c7 ff ff       	call   80101a00 <iunlockput>
    end_op();
80105235:	e8 66 db ff ff       	call   80102da0 <end_op>
    return -1;
...
80105278:	83 ec 0c             	sub    $0xc,%esp
      curproc->ofile[fd] = f;
8010527b:	89 7c 98 2c          	mov    %edi,0x2c(%eax,%ebx,4)
  iunlock(ip);
8010527f:	56                   	push   %esi
80105280:	e8 bb c5 ff ff       	call   80101840 <iunlock>
  end_op();
...
80105313:	e8 e8 c6 ff ff       	call   80101a00 <iunlockput>
  end_op();
...
80105352:	8d 45 ec             	lea    -0x14(%ebp),%eax
80105355:	50                   	push   %eax
80105356:	6a 00                	push   $0x0
80105358:	e8 53 f6 ff ff       	call   801049b0 <argstr>
8010535d:	83 c4 10             	add    $0x10,%esp
80105360:	85 c0                	test   %eax,%eax
80105362:	78 64                	js     801053c8 <sys_mknod+0x88>
     argint(1, &major) < 0 ||
80105364:	83 ec 08             	sub    $0x8,%esp
80105367:	8d 45 f0             	lea    -0x10(%ebp),%eax
8010536a:	50                   	push   %eax
8010536b:	6a 01                	push   $0x1
8010536d:	e8 8e f5 ff ff       	call   80104900 <argint>
  if((argstr(0, &path)) < 0 ||
80105372:	83 c4 10             	add    $0x10,%esp
80105375:	85 c0                	test   %eax,%eax
80105377:	78 4f                	js     801053c8 <sys_mknod+0x88>
     argint(2, &minor) < 0 ||
80105379:	83 ec 08             	sub    $0x8,%esp
8010537c:	8d 45 f4             	lea    -0xc(%ebp),%eax
8010537f:	50                   	push   %eax
80105380:	6a 02                	push   $0x2
80105382:	e8 79 f5 ff ff       	call   80104900 <argint>
     argint(1, &major) < 0 ||
80105387:	83 c4 10             	add    $0x10,%esp
8010538a:	85 c0                	test   %eax,%eax
8010538c:	78 3a                	js     801053c8 <sys_mknod+0x88>
     (ip = create(path, T_DEV, major, minor)) == 0){
8010538e:	0f bf 45 f4          	movswl -0xc(%ebp),%eax
80105392:	83 ec 0c             	sub    $0xc,%esp
80105395:	0f bf 4d f0          	movswl -0x10(%ebp),%ecx
80105399:	ba 03 00 00 00       	mov    $0x3,%edx
8010539e:	50                   	push   %eax
8010539f:	8b 45 ec             	mov    -0x14(%ebp),%eax
801053a2:	e8 d9 f6 ff ff       	call   80104a80 <create>
     argint(2, &minor) < 0 ||
801053a7:	83 c4 10             	add    $0x10,%esp
801053aa:	85 c0                	test   %eax,%eax
801053ac:	74 1a                	je     801053c8 <sys_mknod+0x88>
    end_op();
    return -1;
  }
  iunlockput(ip);
...
801053b2:	e8 49 c6 ff ff       	call   80101a00 <iunlockput>
  end_op();
801053b7:	e8 e4 d9 ff ff       	call   80102da0 <end_op>
  return 0;
...
80105425:	e8 36 c3 ff ff       	call   80101760 <ilock>
  if(ip->type != T_DIR){
8010542a:	83 c4 10             	add    $0x10,%esp
8010542d:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
80105432:	75 2c                	jne    80105460 <sys_chdir+0x80>
    iunlockput(ip);
    end_op();
    return -1;
  }
...
80105438:	e8 03 c4 ff ff       	call   80101840 <iunlock>
  iput(curproc->cwd);
8010543d:	58                   	pop    %eax
8010543e:	ff 76 6c             	pushl  0x6c(%esi)
80105441:	e8 4a c4 ff ff       	call   80101890 <iput>
  end_op();
80105446:	e8 55 d9 ff ff       	call   80102da0 <end_op>
  curproc->cwd = ip;
8010544b:	89 5e 6c             	mov    %ebx,0x6c(%esi)
  return 0;
...
80105464:	e8 97 c5 ff ff       	call   80101a00 <iunlockput>
    end_op();
80105469:	e8 32 d9 ff ff       	call   80102da0 <end_op>
    return -1;
...
8010547f:	90                   	nop
    end_op();
80105480:	e8 1b d9 ff ff       	call   80102da0 <end_op>
    return -1;
...
80105499:	8d 85 5c ff ff ff    	lea    -0xa4(%ebp),%eax
{
8010549f:	53                   	push   %ebx
801054a0:	81 ec a4 00 00 00    	sub    $0xa4,%esp
  if(argstr(0, &path) < 0 || argint(1, (int*)&uargv) < 0){
801054a6:	50                   	push   %eax
801054a7:	6a 00                	push   $0x0
801054a9:	e8 02 f5 ff ff       	call   801049b0 <argstr>
801054ae:	83 c4 10             	add    $0x10,%esp
801054b1:	85 c0                	test   %eax,%eax
801054b3:	0f 88 8b 00 00 00    	js     80105544 <sys_exec+0xb4>
801054b9:	83 ec 08             	sub    $0x8,%esp
801054bc:	8d 85 60 ff ff ff    	lea    -0xa0(%ebp),%eax
801054c2:	50                   	push   %eax
801054c3:	6a 01                	push   $0x1
801054c5:	e8 36 f4 ff ff       	call   80104900 <argint>
801054ca:	83 c4 10             	add    $0x10,%esp
801054cd:	85 c0                	test   %eax,%eax
801054cf:	78 73                	js     80105544 <sys_exec+0xb4>
    return -1;
  }
...
801054da:	31 db                	xor    %ebx,%ebx
  memset(argv, 0, sizeof(argv));
801054dc:	68 80 00 00 00       	push   $0x80
801054e1:	8d bd 64 ff ff ff    	lea    -0x9c(%ebp),%edi
801054e7:	6a 00                	push   $0x0
801054e9:	50                   	push   %eax
801054ea:	e8 31 f1 ff ff       	call   80104620 <memset>
801054ef:	83 c4 10             	add    $0x10,%esp
801054f2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    if(i >= NELEM(argv))
      return -1;
    if(fetchint(uargv+4*i, (int*)&uarg) < 0)
801054f8:	8b 85 60 ff ff ff    	mov    -0xa0(%ebp),%eax
801054fe:	8d 34 9d 00 00 00 00 	lea    0x0(,%ebx,4),%esi
80105505:	83 ec 08             	sub    $0x8,%esp
80105508:	57                   	push   %edi
80105509:	01 f0                	add    %esi,%eax
8010550b:	50                   	push   %eax
8010550c:	e8 4f f3 ff ff       	call   80104860 <fetchint>
80105511:	83 c4 10             	add    $0x10,%esp
80105514:	85 c0                	test   %eax,%eax
80105516:	78 2c                	js     80105544 <sys_exec+0xb4>
      return -1;
    if(uarg == 0){
80105518:	8b 85 64 ff ff ff    	mov    -0x9c(%ebp),%eax
8010551e:	85 c0                	test   %eax,%eax
80105520:	74 36                	je     80105558 <sys_exec+0xc8>
      argv[i] = 0;
      break;
    }
    if(fetchstr(uarg, &argv[i]) < 0)
80105522:	8d 8d 68 ff ff ff    	lea    -0x98(%ebp),%ecx
80105528:	83 ec 08             	sub    $0x8,%esp
8010552b:	8d 14 31             	lea    (%ecx,%esi,1),%edx
8010552e:	52                   	push   %edx
8010552f:	50                   	push   %eax
80105530:	e8 6b f3 ff ff       	call   801048a0 <fetchstr>
80105535:	83 c4 10             	add    $0x10,%esp
80105538:	85 c0                	test   %eax,%eax
8010553a:	78 08                	js     80105544 <sys_exec+0xb4>
  for(i=0;; i++){
8010553c:	83 c3 01             	add    $0x1,%ebx
    if(i >= NELEM(argv))
8010553f:	83 fb 20             	cmp    $0x20,%ebx
80105542:	75 b4                	jne    801054f8 <sys_exec+0x68>
      return -1;
  }
...
8010555b:	8d 85 68 ff ff ff    	lea    -0x98(%ebp),%eax
      argv[i] = 0;
80105561:	c7 84 9d 68 ff ff ff 	movl   $0x0,-0x98(%ebp,%ebx,4)
80105568:	00 00 00 00 
  return exec(path, argv);
8010556c:	50                   	push   %eax
8010556d:	ff b5 5c ff ff ff    	pushl  -0xa4(%ebp)
80105573:	e8 08 b5 ff ff       	call   80100a80 <exec>
80105578:	83 c4 10             	add    $0x10,%esp
}
8010557b:	8d 65 f4             	lea    -0xc(%ebp),%esp
8010557e:	5b                   	pop    %ebx
8010557f:	5e                   	pop    %esi
80105580:	5f                   	pop    %edi
80105581:	5d                   	pop    %ebp
...
80105599:	8d 45 dc             	lea    -0x24(%ebp),%eax
{
8010559c:	53                   	push   %ebx
8010559d:	83 ec 20             	sub    $0x20,%esp
  if(argptr(0, (void*)&fd, 2*sizeof(fd[0])) < 0)
801055a0:	6a 08                	push   $0x8
801055a2:	50                   	push   %eax
801055a3:	6a 00                	push   $0x0
801055a5:	e8 a6 f3 ff ff       	call   80104950 <argptr>
801055aa:	83 c4 10             	add    $0x10,%esp
801055ad:	85 c0                	test   %eax,%eax
801055af:	78 4e                	js     801055ff <sys_pipe+0x6f>
    return -1;
...
801055bc:	e8 2f de ff ff       	call   801033f0 <pipealloc>
801055c1:	83 c4 10             	add    $0x10,%esp
801055c4:	85 c0                	test   %eax,%eax
801055c6:	78 37                	js     801055ff <sys_pipe+0x6f>
    return -1;
  fd0 = -1;
  if((fd0 = fdalloc(rf)) < 0 || (fd1 = fdalloc(wf)) < 0){
801055c8:	8b 7d e0             	mov    -0x20(%ebp),%edi
  for(fd = 0; fd < NOFILE; fd++){
801055cb:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
801055cd:	e8 8e e3 ff ff       	call   80103960 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
801055d2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    if(curproc->ofile[fd] == 0){
801055d8:	8b 74 98 2c          	mov    0x2c(%eax,%ebx,4),%esi
801055dc:	85 f6                	test   %esi,%esi
801055de:	74 30                	je     80105610 <sys_pipe+0x80>
  for(fd = 0; fd < NOFILE; fd++){
801055e0:	83 c3 01             	add    $0x1,%ebx
801055e3:	83 fb 10             	cmp    $0x10,%ebx
801055e6:	75 f0                	jne    801055d8 <sys_pipe+0x48>
    if(fd0 >= 0)
      myproc()->ofile[fd0] = 0;
    fileclose(rf);
801055e8:	83 ec 0c             	sub    $0xc,%esp
801055eb:	ff 75 e0             	pushl  -0x20(%ebp)
801055ee:	e8 cd b8 ff ff       	call   80100ec0 <fileclose>
    fileclose(wf);
801055f3:	58                   	pop    %eax
801055f4:	ff 75 e4             	pushl  -0x1c(%ebp)
801055f7:	e8 c4 b8 ff ff       	call   80100ec0 <fileclose>
    return -1;
801055fc:	83 c4 10             	add    $0x10,%esp
801055ff:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105604:	eb 5b                	jmp    80105661 <sys_pipe+0xd1>
80105606:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
8010560d:	8d 76 00             	lea    0x0(%esi),%esi
      curproc->ofile[fd] = f;
80105610:	8d 73 08             	lea    0x8(%ebx),%esi
80105613:	89 7c b0 0c          	mov    %edi,0xc(%eax,%esi,4)
  if((fd0 = fdalloc(rf)) < 0 || (fd1 = fdalloc(wf)) < 0){
...
80105670:	f3 0f 1e fb          	endbr32 
  return fork();
80105674:	e9 87 e4 ff ff       	jmp    80103b00 <fork>
...
80105687:	83 ec 08             	sub    $0x8,%esp
  exit();
8010568a:	e8 e1 e6 ff ff       	call   80103d70 <exit>
...
801056a0:	f3 0f 1e fb          	endbr32 
  return wait();
801056a4:	e9 f7 e8 ff ff       	jmp    80103fa0 <wait>
...
801056c0:	e8 3b f2 ff ff       	call   80104900 <argint>
801056c5:	83 c4 10             	add    $0x10,%esp
801056c8:	85 c0                	test   %eax,%eax
801056ca:	78 14                	js     801056e0 <sys_kill+0x30>
    return -1;
  return kill(pid);
801056cc:	83 ec 0c             	sub    $0xc,%esp
801056cf:	ff 75 f4             	pushl  -0xc(%ebp)
801056d2:	e8 19 ea ff ff       	call   801040f0 <kill>
...
801056ff:	8b 40 14             	mov    0x14(%eax),%eax
}
80105702:	c9                   	leave  
80105703:	c3                   	ret    
80105704:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
8010570b:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
8010570f:	90                   	nop

80105710 <sys_getreadcount>:
...
{
8010573b:	83 ec 1c             	sub    $0x1c,%esp
  if(argint(0, &n) < 0)
8010573e:	50                   	push   %eax
8010573f:	6a 00                	push   $0x0
80105741:	e8 ba f1 ff ff       	call   80104900 <argint>
80105746:	83 c4 10             	add    $0x10,%esp
80105749:	85 c0                	test   %eax,%eax
8010574b:	78 23                	js     80105770 <sys_sbrk+0x40>
    return -1;
  addr = myproc()->sz;
...
80105752:	83 ec 0c             	sub    $0xc,%esp
  addr = myproc()->sz;
80105755:	8b 58 04             	mov    0x4(%eax),%ebx
  if(growproc(n) < 0)
80105758:	ff 75 f4             	pushl  -0xc(%ebp)
8010575b:	e8 30 e3 ff ff       	call   80103a90 <growproc>
80105760:	83 c4 10             	add    $0x10,%esp
80105763:	85 c0                	test   %eax,%eax
80105765:	78 09                	js     80105770 <sys_sbrk+0x40>
    return -1;
  return addr;
}
80105767:	89 d8                	mov    %ebx,%eax
80105769:	8b 5d fc             	mov    -0x4(%ebp),%ebx
8010576c:	c9                   	leave  
8010576d:	c3                   	ret    
8010576e:	66 90                	xchg   %ax,%ax
    return -1;
80105770:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
80105775:	eb f0                	jmp    80105767 <sys_sbrk+0x37>
...
80105791:	e8 6a f1 ff ff       	call   80104900 <argint>
80105796:	83 c4 10             	add    $0x10,%esp
80105799:	85 c0                	test   %eax,%eax
8010579b:	0f 88 86 00 00 00    	js     80105827 <sys_sleep+0xa7>
    return -1;
  acquire(&tickslock);
801057a1:	83 ec 0c             	sub    $0xc,%esp
801057a4:	68 60 4d 11 80       	push   $0x80114d60
801057a9:	e8 62 ed ff ff       	call   80104510 <acquire>
  ticks0 = ticks;
...
801057ba:	85 d2                	test   %edx,%edx
801057bc:	75 23                	jne    801057e1 <sys_sleep+0x61>
801057be:	eb 50                	jmp    80105810 <sys_sleep+0x90>
    if(myproc()->killed){
      release(&tickslock);
      return -1;
    }
...
801057c8:	68 a0 55 11 80       	push   $0x801155a0
801057cd:	e8 0e e7 ff ff       	call   80103ee0 <sleep>
  while(ticks - ticks0 < n){
801057d2:	a1 a0 55 11 80       	mov    0x801155a0,%eax
...
801057f0:	68 60 4d 11 80       	push   $0x80114d60
801057f5:	e8 d6 ed ff ff       	call   801045d0 <release>
  }
  release(&tickslock);
  return 0;
}
...
80105813:	68 60 4d 11 80       	push   $0x80114d60
80105818:	e8 b3 ed ff ff       	call   801045d0 <release>
  return 0;
...
80105838:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
8010583b:	68 60 4d 11 80       	push   $0x80114d60
80105840:	e8 cb ec ff ff       	call   80104510 <acquire>
  xticks = ticks;
80105845:	8b 1d a0 55 11 80    	mov    0x801155a0,%ebx
  release(&tickslock);
8010584b:	c7 04 24 60 4d 11 80 	movl   $0x80114d60,(%esp)
80105852:	e8 79 ed ff ff       	call   801045d0 <release>
  return xticks;
}
80105857:	89 d8                	mov    %ebx,%eax
...
8010585f:	06                   	push   %es
  pushl %fs
80105860:	0f a0                	push   %fs
  pushl %gs
80105862:	0f a8                	push   %gs
  pushal
80105864:	60                   	pusha  
  
  # Set up data segments.
  movw $(SEG_KDATA<<3), %ax
80105865:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
80105869:	8e d8                	mov    %eax,%ds
  movw %ax, %es
8010586b:	8e c0                	mov    %eax,%es

  # Call trap(tf), where tf=%esp
  pushl %esp
8010586d:	54                   	push   %esp
  call trap
8010586e:	e8 cd 00 00 00       	call   80105940 <trap>
  addl $4, %esp
80105873:	83 c4 04             	add    $0x4,%esp
...
80105876:	61                   	popa   
  popl %gs
80105877:	0f a9                	pop    %gs
  popl %fs
80105879:	0f a1                	pop    %fs
  popl %es
8010587b:	07                   	pop    %es
  popl %ds
8010587c:	1f                   	pop    %ds
...
801058a7:	c7 04 c5 a2 4d 11 80 	movl   $0x8e000008,-0x7feeb25e(,%eax,8)
801058ae:	08 00 00 8e 
801058b2:	66 89 14 c5 a0 4d 11 	mov    %dx,-0x7feeb260(,%eax,8)
801058b9:	80 
801058ba:	c1 ea 10             	shr    $0x10,%edx
801058bd:	66 89 14 c5 a6 4d 11 	mov    %dx,-0x7feeb25a(,%eax,8)
801058c4:	80 
  for(i = 0; i < 256; i++)
...
801058d7:	c7 05 a2 4f 11 80 08 	movl   $0xef000008,0x80114fa2
801058de:	00 00 ef 
  initlock(&tickslock, "time");
801058e1:	68 5d 78 10 80       	push   $0x8010785d
801058e6:	68 60 4d 11 80       	push   $0x80114d60
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
801058eb:	66 a3 a0 4f 11 80    	mov    %ax,0x80114fa0
801058f1:	c1 e8 10             	shr    $0x10,%eax
801058f4:	66 a3 a6 4f 11 80    	mov    %ax,0x80114fa6
  initlock(&tickslock, "time");
801058fa:	e8 91 ea ff ff       	call   80104390 <initlock>
}
...
80105914:	55                   	push   %ebp
  pd[0] = size-1;
80105915:	b8 ff 07 00 00       	mov    $0x7ff,%eax
8010591a:	89 e5                	mov    %esp,%ebp
8010591c:	83 ec 10             	sub    $0x10,%esp
8010591f:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80105923:	b8 a0 4d 11 80       	mov    $0x80114da0,%eax
80105928:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  pd[2] = (uint)p >> 16;
8010592c:	c1 e8 10             	shr    $0x10,%eax
8010592f:	66 89 45 fe          	mov    %ax,-0x2(%ebp)
  asm volatile("lidt (%0)" : : "r" (pd));
80105933:	8d 45 fa             	lea    -0x6(%ebp),%eax
80105936:	0f 01 18             	lidtl  (%eax)
  lidt(idt, sizeof(idt));
}
80105939:	c9                   	leave  
8010593a:	c3                   	ret    
...
8010594a:	83 ec 1c             	sub    $0x1c,%esp
8010594d:	8b 5d 08             	mov    0x8(%ebp),%ebx
  if(tf->trapno == T_SYSCALL){
80105950:	8b 43 30             	mov    0x30(%ebx),%eax
80105953:	83 f8 40             	cmp    $0x40,%eax
80105956:	0f 84 bc 01 00 00    	je     80105b18 <trap+0x1d8>
    if(myproc()->killed)
      exit();
    return;
  }
  ...
  switch(tf->trapno){
8010595c:	83 e8 20             	sub    $0x20,%eax
8010595f:	83 f8 1f             	cmp    $0x1f,%eax
80105962:	77 08                	ja     8010596c <trap+0x2c>
80105964:	3e ff 24 85 04 79 10 	notrack jmp *-0x7fef86fc(,%eax,4)
8010596b:	80 
    lapiceoi();
    break;
...
8010596c:	e8 ef df ff ff       	call   80103960 <myproc>
80105971:	8b 7b 38             	mov    0x38(%ebx),%edi
80105974:	85 c0                	test   %eax,%eax
80105976:	0f 84 eb 01 00 00    	je     80105b67 <trap+0x227>
8010597c:	f6 43 3c 03          	testb  $0x3,0x3c(%ebx)
80105980:	0f 84 e1 01 00 00    	je     80105b67 <trap+0x227>
...
80105986:	0f 20 d1             	mov    %cr2,%ecx
80105989:	89 4d d8             	mov    %ecx,-0x28(%ebp)
...
8010598c:	e8 af df ff ff       	call   80103940 <cpuid>
80105991:	8b 73 30             	mov    0x30(%ebx),%esi
80105994:	89 45 dc             	mov    %eax,-0x24(%ebp)
80105997:	8b 43 34             	mov    0x34(%ebx),%eax
8010599a:	89 45 e4             	mov    %eax,-0x1c(%ebp)
            "eip 0x%x addr 0x%x--kill proc\n",
            myproc()->pid, myproc()->name, tf->trapno,
8010599d:	e8 be df ff ff       	call   80103960 <myproc>
801059a2:	89 45 e0             	mov    %eax,-0x20(%ebp)
801059a5:	e8 b6 df ff ff       	call   80103960 <myproc>
    cprintf("pid %d %s: trap %d err %d on cpu %d "
801059aa:	8b 4d d8             	mov    -0x28(%ebp),%ecx
801059ad:	8b 55 dc             	mov    -0x24(%ebp),%edx
801059b0:	51                   	push   %ecx
801059b1:	57                   	push   %edi
801059b2:	52                   	push   %edx
801059b3:	ff 75 e4             	pushl  -0x1c(%ebp)
801059b6:	56                   	push   %esi
            myproc()->pid, myproc()->name, tf->trapno,
801059b7:	8b 75 e0             	mov    -0x20(%ebp),%esi
801059ba:	83 c6 70             	add    $0x70,%esi
    cprintf("pid %d %s: trap %d err %d on cpu %d "
801059bd:	56                   	push   %esi
801059be:	ff 70 14             	pushl  0x14(%eax)
801059c1:	68 c0 78 10 80       	push   $0x801078c0
801059c6:	e8 e5 ac ff ff       	call   801006b0 <cprintf>
            tf->err, cpuid(), tf->eip, rcr2());
    myproc()->killed = 1;
801059cb:	83 c4 20             	add    $0x20,%esp
801059ce:	e8 8d df ff ff       	call   80103960 <myproc>
801059d3:	c7 40 28 01 00 00 00 	movl   $0x1,0x28(%eax)
  }
...
801059e1:	74 1d                	je     80105a00 <trap+0xc0>
801059e3:	e8 78 df ff ff       	call   80103960 <myproc>
801059e8:	8b 50 28             	mov    0x28(%eax),%edx
801059eb:	85 d2                	test   %edx,%edx
801059ed:	74 11                	je     80105a00 <trap+0xc0>
801059ef:	0f b7 43 3c          	movzwl 0x3c(%ebx),%eax
801059f3:	83 e0 03             	and    $0x3,%eax
801059f6:	66 83 f8 03          	cmp    $0x3,%ax
801059fa:	0f 84 50 01 00 00    	je     80105b50 <trap+0x210>
    exit();
...
80105a45:	c3                   	ret    
    ideintr();
80105a46:	e8 95 c7 ff ff       	call   801021e0 <ideintr>
    lapiceoi();
80105a4b:	e8 70 ce ff ff       	call   801028c0 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105a50:	e8 0b df ff ff       	call   80103960 <myproc>
80105a55:	85 c0                	test   %eax,%eax
80105a57:	75 8a                	jne    801059e3 <trap+0xa3>
80105a59:	eb a5                	jmp    80105a00 <trap+0xc0>
    if(cpuid() == 0){
80105a5b:	e8 e0 de ff ff       	call   80103940 <cpuid>
80105a60:	85 c0                	test   %eax,%eax
80105a62:	75 e7                	jne    80105a4b <trap+0x10b>
      acquire(&tickslock);
80105a64:	83 ec 0c             	sub    $0xc,%esp
80105a67:	68 60 4d 11 80       	push   $0x80114d60
80105a6c:	e8 9f ea ff ff       	call   80104510 <acquire>
      wakeup(&ticks);
80105a71:	c7 04 24 a0 55 11 80 	movl   $0x801155a0,(%esp)
      ticks++;
80105a78:	83 05 a0 55 11 80 01 	addl   $0x1,0x801155a0
      wakeup(&ticks);
80105a7f:	e8 0c e6 ff ff       	call   80104090 <wakeup>
      release(&tickslock);
80105a84:	c7 04 24 60 4d 11 80 	movl   $0x80114d60,(%esp)
80105a8b:	e8 40 eb ff ff       	call   801045d0 <release>
80105a90:	83 c4 10             	add    $0x10,%esp
    lapiceoi();
80105a93:	eb b6                	jmp    80105a4b <trap+0x10b>
    kbdintr();
80105a95:	e8 e6 cc ff ff       	call   80102780 <kbdintr>
    lapiceoi();
80105a9a:	e8 21 ce ff ff       	call   801028c0 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105a9f:	e8 bc de ff ff       	call   80103960 <myproc>
80105aa4:	85 c0                	test   %eax,%eax
80105aa6:	0f 85 37 ff ff ff    	jne    801059e3 <trap+0xa3>
80105aac:	e9 4f ff ff ff       	jmp    80105a00 <trap+0xc0>
    uartintr();
80105ab1:	e8 4a 02 00 00       	call   80105d00 <uartintr>
    lapiceoi();
80105ab6:	e8 05 ce ff ff       	call   801028c0 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105abb:	e8 a0 de ff ff       	call   80103960 <myproc>
80105ac0:	85 c0                	test   %eax,%eax
80105ac2:	0f 85 1b ff ff ff    	jne    801059e3 <trap+0xa3>
80105ac8:	e9 33 ff ff ff       	jmp    80105a00 <trap+0xc0>
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
80105acd:	8b 7b 38             	mov    0x38(%ebx),%edi
80105ad0:	0f b7 73 3c          	movzwl 0x3c(%ebx),%esi
80105ad4:	e8 67 de ff ff       	call   80103940 <cpuid>
80105ad9:	57                   	push   %edi
80105ada:	56                   	push   %esi
80105adb:	50                   	push   %eax
80105adc:	68 68 78 10 80       	push   $0x80107868
80105ae1:	e8 ca ab ff ff       	call   801006b0 <cprintf>
    lapiceoi();
80105ae6:	e8 d5 cd ff ff       	call   801028c0 <lapiceoi>
    break;
80105aeb:	83 c4 10             	add    $0x10,%esp
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105aee:	e8 6d de ff ff       	call   80103960 <myproc>
80105af3:	85 c0                	test   %eax,%eax
80105af5:	0f 85 e8 fe ff ff    	jne    801059e3 <trap+0xa3>
80105afb:	e9 00 ff ff ff       	jmp    80105a00 <trap+0xc0>
  if(myproc() && myproc()->state == RUNNING &&
80105b00:	83 7b 30 20          	cmpl   $0x20,0x30(%ebx)
80105b04:	0f 85 0e ff ff ff    	jne    80105a18 <trap+0xd8>
    yield();
80105b0a:	e8 91 e3 ff ff       	call   80103ea0 <yield>
80105b0f:	e9 04 ff ff ff       	jmp    80105a18 <trap+0xd8>
80105b14:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    if(myproc()->killed)
80105b18:	e8 43 de ff ff       	call   80103960 <myproc>
80105b1d:	8b 70 28             	mov    0x28(%eax),%esi
80105b20:	85 f6                	test   %esi,%esi
80105b22:	75 3c                	jne    80105b60 <trap+0x220>
    myproc()->tf = tf;
80105b24:	e8 37 de ff ff       	call   80103960 <myproc>
80105b29:	89 58 1c             	mov    %ebx,0x1c(%eax)
    syscall();
80105b2c:	e8 bf ee ff ff       	call   801049f0 <syscall>
    if(myproc()->killed)
80105b31:	e8 2a de ff ff       	call   80103960 <myproc>
80105b36:	8b 48 28             	mov    0x28(%eax),%ecx
80105b39:	85 c9                	test   %ecx,%ecx
80105b3b:	0f 84 fd fe ff ff    	je     80105a3e <trap+0xfe>
}
...
80105b47:	5d                   	pop    %ebp
      exit();
80105b48:	e9 23 e2 ff ff       	jmp    80103d70 <exit>
80105b4d:	8d 76 00             	lea    0x0(%esi),%esi
    exit();
80105b50:	e8 1b e2 ff ff       	call   80103d70 <exit>
80105b55:	e9 a6 fe ff ff       	jmp    80105a00 <trap+0xc0>
80105b5a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      exit();
80105b60:	e8 0b e2 ff ff       	call   80103d70 <exit>
80105b65:	eb bd                	jmp    80105b24 <trap+0x1e4>
80105b67:	0f 20 d6             	mov    %cr2,%esi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80105b6a:	e8 d1 dd ff ff       	call   80103940 <cpuid>
80105b6f:	83 ec 0c             	sub    $0xc,%esp
80105b72:	56                   	push   %esi
80105b73:	57                   	push   %edi
80105b74:	50                   	push   %eax
80105b75:	ff 73 30             	pushl  0x30(%ebx)
80105b78:	68 8c 78 10 80       	push   $0x8010788c
80105b7d:	e8 2e ab ff ff       	call   801006b0 <cprintf>
      panic("trap");
80105b82:	83 c4 14             	add    $0x14,%esp
80105b85:	68 62 78 10 80       	push   $0x80107862
80105b8a:	e8 01 a8 ff ff       	call   80100390 <panic>
80105b8f:	90                   	nop
...
80105b90:	f3 0f 1e fb          	endbr32 
  if(!uart)
80105b94:	a1 bc a5 10 80       	mov    0x8010a5bc,%eax
80105b99:	85 c0                	test   %eax,%eax
80105b9b:	74 1b                	je     80105bb8 <uartgetc+0x28>
  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
80105b9d:	ba fd 03 00 00       	mov    $0x3fd,%edx
80105ba2:	ec                   	in     (%dx),%al
    return -1;
  if(!(inb(COM1+5) & 0x01))
80105ba3:	a8 01                	test   $0x1,%al
80105ba5:	74 11                	je     80105bb8 <uartgetc+0x28>
80105ba7:	ba f8 03 00 00       	mov    $0x3f8,%edx
80105bac:	ec                   	in     (%dx),%al
    return -1;
  return inb(COM1+0);
80105bad:	0f b6 c0             	movzbl %al,%eax
80105bb0:	c3                   	ret    
...
80105bc4:	89 c7                	mov    %eax,%edi
80105bc6:	56                   	push   %esi
80105bc7:	be fd 03 00 00       	mov    $0x3fd,%esi
80105bcc:	53                   	push   %ebx
80105bcd:	bb 80 00 00 00       	mov    $0x80,%ebx
...
80105be5:	e8 f6 cc ff ff       	call   801028e0 <microdelay>
...
80105c15:	31 c9                	xor    %ecx,%ecx
80105c17:	89 c8                	mov    %ecx,%eax
80105c19:	89 e5                	mov    %esp,%ebp
80105c1b:	57                   	push   %edi
80105c1c:	56                   	push   %esi
80105c1d:	53                   	push   %ebx
80105c1e:	bb fa 03 00 00       	mov    $0x3fa,%ebx
80105c23:	89 da                	mov    %ebx,%edx
80105c25:	83 ec 0c             	sub    $0xc,%esp
80105c28:	ee                   	out    %al,(%dx)
80105c29:	bf fb 03 00 00       	mov    $0x3fb,%edi
80105c2e:	b8 80 ff ff ff       	mov    $0xffffff80,%eax
80105c33:	89 fa                	mov    %edi,%edx
80105c35:	ee                   	out    %al,(%dx)
80105c36:	b8 0c 00 00 00       	mov    $0xc,%eax
80105c3b:	ba f8 03 00 00       	mov    $0x3f8,%edx
80105c40:	ee                   	out    %al,(%dx)
80105c41:	be f9 03 00 00       	mov    $0x3f9,%esi
80105c46:	89 c8                	mov    %ecx,%eax
80105c48:	89 f2                	mov    %esi,%edx
80105c4a:	ee                   	out    %al,(%dx)
80105c4b:	b8 03 00 00 00       	mov    $0x3,%eax
80105c50:	89 fa                	mov    %edi,%edx
80105c52:	ee                   	out    %al,(%dx)
80105c53:	ba fc 03 00 00       	mov    $0x3fc,%edx
80105c58:	89 c8                	mov    %ecx,%eax
80105c5a:	ee                   	out    %al,(%dx)
80105c5b:	b8 01 00 00 00       	mov    $0x1,%eax
80105c60:	89 f2                	mov    %esi,%edx
80105c62:	ee                   	out    %al,(%dx)
  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
80105c63:	ba fd 03 00 00       	mov    $0x3fd,%edx
80105c68:	ec                   	in     (%dx),%al
  if(inb(COM1+5) == 0xFF)
80105c69:	3c ff                	cmp    $0xff,%al
80105c6b:	74 52                	je     80105cbf <uartinit+0xaf>
  uart = 1;
80105c6d:	c7 05 bc a5 10 80 01 	movl   $0x1,0x8010a5bc
80105c74:	00 00 00 
80105c77:	89 da                	mov    %ebx,%edx
80105c79:	ec                   	in     (%dx),%al
80105c7a:	ba f8 03 00 00       	mov    $0x3f8,%edx
80105c7f:	ec                   	in     (%dx),%al
  ioapicenable(IRQ_COM1, 0);
80105c80:	83 ec 08             	sub    $0x8,%esp
80105c83:	be 76 00 00 00       	mov    $0x76,%esi
  for(p="xv6...\n"; *p; p++)
80105c88:	bb 84 79 10 80       	mov    $0x80107984,%ebx
  ioapicenable(IRQ_COM1, 0);
80105c8d:	6a 00                	push   $0x0
80105c8f:	6a 04                	push   $0x4
80105c91:	e8 9a c7 ff ff       	call   80102430 <ioapicenable>
80105c96:	83 c4 10             	add    $0x10,%esp
  for(p="xv6...\n"; *p; p++)
80105c99:	b8 78 00 00 00       	mov    $0x78,%eax
80105c9e:	eb 04                	jmp    80105ca4 <uartinit+0x94>
80105ca0:	0f b6 73 01          	movzbl 0x1(%ebx),%esi
  if(!uart)
80105ca4:	8b 15 bc a5 10 80    	mov    0x8010a5bc,%edx
80105caa:	85 d2                	test   %edx,%edx
80105cac:	74 08                	je     80105cb6 <uartinit+0xa6>
    uartputc(*p);
80105cae:	0f be c0             	movsbl %al,%eax
80105cb1:	e8 0a ff ff ff       	call   80105bc0 <uartputc.part.0>
  for(p="xv6...\n"; *p; p++)
80105cb6:	89 f0                	mov    %esi,%eax
80105cb8:	83 c3 01             	add    $0x1,%ebx
80105cbb:	84 c0                	test   %al,%al
80105cbd:	75 e1                	jne    80105ca0 <uartinit+0x90>
}
...
80105cd4:	55                   	push   %ebp
  if(!uart)
80105cd5:	8b 15 bc a5 10 80    	mov    0x8010a5bc,%edx
{
80105cdb:	89 e5                	mov    %esp,%ebp
80105cdd:	8b 45 08             	mov    0x8(%ebp),%eax
  if(!uart)
80105ce0:	85 d2                	test   %edx,%edx
80105ce2:	74 0c                	je     80105cf0 <uartputc+0x20>
}
80105ce4:	5d                   	pop    %ebp
80105ce5:	e9 d6 fe ff ff       	jmp    80105bc0 <uartputc.part.0>
...
80105d07:	83 ec 14             	sub    $0x14,%esp
  consoleintr(uartgetc);
80105d0a:	68 90 5b 10 80       	push   $0x80105b90
80105d0f:	e8 4c ab ff ff       	call   80100860 <consoleintr>
}
...
80105d1b:	6a 00                	push   $0x0
  jmp alltraps
80105d1d:	e9 3c fb ff ff       	jmp    8010585e <alltraps>
...
80105d22:	6a 00                	push   $0x0
  pushl $1
80105d24:	6a 01                	push   $0x1
  jmp alltraps
80105d26:	e9 33 fb ff ff       	jmp    8010585e <alltraps>
...
80105d2b:	6a 00                	push   $0x0
  pushl $2
80105d2d:	6a 02                	push   $0x2
  jmp alltraps
80105d2f:	e9 2a fb ff ff       	jmp    8010585e <alltraps>
...
80105d34:	6a 00                	push   $0x0
  pushl $3
80105d36:	6a 03                	push   $0x3
  jmp alltraps
80105d38:	e9 21 fb ff ff       	jmp    8010585e <alltraps>
...
80105d3f:	6a 04                	push   $0x4
  jmp alltraps
80105d41:	e9 18 fb ff ff       	jmp    8010585e <alltraps>
...
80105d46:	6a 00                	push   $0x0
  pushl $5
80105d48:	6a 05                	push   $0x5
  jmp alltraps
80105d4a:	e9 0f fb ff ff       	jmp    8010585e <alltraps>
...
80105d4f:	6a 00                	push   $0x0
  pushl $6
80105d51:	6a 06                	push   $0x6
  jmp alltraps
80105d53:	e9 06 fb ff ff       	jmp    8010585e <alltraps>
...
80105d58:	6a 00                	push   $0x0
  pushl $7
80105d5a:	6a 07                	push   $0x7
  jmp alltraps
80105d5c:	e9 fd fa ff ff       	jmp    8010585e <alltraps>

80105d61 <vector8>:
.globl vector8
vector8:
  pushl $8
80105d61:	6a 08                	push   $0x8
  jmp alltraps
80105d63:	e9 f6 fa ff ff       	jmp    8010585e <alltraps>
...
80105d68:	6a 00                	push   $0x0
  pushl $9
80105d6a:	6a 09                	push   $0x9
  jmp alltraps
80105d6c:	e9 ed fa ff ff       	jmp    8010585e <alltraps>

80105d71 <vector10>:
.globl vector10
vector10:
  pushl $10
80105d71:	6a 0a                	push   $0xa
  jmp alltraps
80105d73:	e9 e6 fa ff ff       	jmp    8010585e <alltraps>

80105d78 <vector11>:
.globl vector11
vector11:
  pushl $11
80105d78:	6a 0b                	push   $0xb
  jmp alltraps
80105d7a:	e9 df fa ff ff       	jmp    8010585e <alltraps>

80105d7f <vector12>:
.globl vector12
vector12:
  pushl $12
80105d7f:	6a 0c                	push   $0xc
  jmp alltraps
80105d81:	e9 d8 fa ff ff       	jmp    8010585e <alltraps>

80105d86 <vector13>:
.globl vector13
vector13:
  pushl $13
80105d86:	6a 0d                	push   $0xd
  jmp alltraps
80105d88:	e9 d1 fa ff ff       	jmp    8010585e <alltraps>

80105d8d <vector14>:
.globl vector14
vector14:
  pushl $14
80105d8d:	6a 0e                	push   $0xe
  jmp alltraps
80105d8f:	e9 ca fa ff ff       	jmp    8010585e <alltraps>
...
80105d94:	6a 00                	push   $0x0
  pushl $15
80105d96:	6a 0f                	push   $0xf
  jmp alltraps
80105d98:	e9 c1 fa ff ff       	jmp    8010585e <alltraps>
...
80105d9f:	6a 10                	push   $0x10
  jmp alltraps
80105da1:	e9 b8 fa ff ff       	jmp    8010585e <alltraps>

80105da6 <vector17>:
.globl vector17
vector17:
  pushl $17
80105da6:	6a 11                	push   $0x11
  jmp alltraps
80105da8:	e9 b1 fa ff ff       	jmp    8010585e <alltraps>
...
80105dad:	6a 00                	push   $0x0
  pushl $18
80105daf:	6a 12                	push   $0x12
  jmp alltraps
80105db1:	e9 a8 fa ff ff       	jmp    8010585e <alltraps>
...
80105db6:	6a 00                	push   $0x0
  pushl $19
80105db8:	6a 13                	push   $0x13
  jmp alltraps
80105dba:	e9 9f fa ff ff       	jmp    8010585e <alltraps>
...
80105dbf:	6a 00                	push   $0x0
  pushl $20
80105dc1:	6a 14                	push   $0x14
  jmp alltraps
80105dc3:	e9 96 fa ff ff       	jmp    8010585e <alltraps>
...
80105dc8:	6a 00                	push   $0x0
  pushl $21
80105dca:	6a 15                	push   $0x15
  jmp alltraps
80105dcc:	e9 8d fa ff ff       	jmp    8010585e <alltraps>
...
80105dd1:	6a 00                	push   $0x0
  pushl $22
80105dd3:	6a 16                	push   $0x16
  jmp alltraps
80105dd5:	e9 84 fa ff ff       	jmp    8010585e <alltraps>
...
80105dda:	6a 00                	push   $0x0
  pushl $23
80105ddc:	6a 17                	push   $0x17
  jmp alltraps
80105dde:	e9 7b fa ff ff       	jmp    8010585e <alltraps>
...
80105de3:	6a 00                	push   $0x0
  pushl $24
80105de5:	6a 18                	push   $0x18
  jmp alltraps
80105de7:	e9 72 fa ff ff       	jmp    8010585e <alltraps>
...
80105dec:	6a 00                	push   $0x0
  pushl $25
80105dee:	6a 19                	push   $0x19
  jmp alltraps
80105df0:	e9 69 fa ff ff       	jmp    8010585e <alltraps>
...
80105df5:	6a 00                	push   $0x0
  pushl $26
80105df7:	6a 1a                	push   $0x1a
  jmp alltraps
80105df9:	e9 60 fa ff ff       	jmp    8010585e <alltraps>
...
80105dfe:	6a 00                	push   $0x0
  pushl $27
80105e00:	6a 1b                	push   $0x1b
  jmp alltraps
80105e02:	e9 57 fa ff ff       	jmp    8010585e <alltraps>
...
80105e07:	6a 00                	push   $0x0
  pushl $28
80105e09:	6a 1c                	push   $0x1c
  jmp alltraps
80105e0b:	e9 4e fa ff ff       	jmp    8010585e <alltraps>
...
80105e10:	6a 00                	push   $0x0
  pushl $29
80105e12:	6a 1d                	push   $0x1d
  jmp alltraps
80105e14:	e9 45 fa ff ff       	jmp    8010585e <alltraps>
...
80105e19:	6a 00                	push   $0x0
  pushl $30
80105e1b:	6a 1e                	push   $0x1e
  jmp alltraps
80105e1d:	e9 3c fa ff ff       	jmp    8010585e <alltraps>
...
80105e22:	6a 00                	push   $0x0
  pushl $31
80105e24:	6a 1f                	push   $0x1f
  jmp alltraps
80105e26:	e9 33 fa ff ff       	jmp    8010585e <alltraps>
...
80105e2b:	6a 00                	push   $0x0
  pushl $32
80105e2d:	6a 20                	push   $0x20
  jmp alltraps
80105e2f:	e9 2a fa ff ff       	jmp    8010585e <alltraps>
...
80105e34:	6a 00                	push   $0x0
  pushl $33
80105e36:	6a 21                	push   $0x21
  jmp alltraps
80105e38:	e9 21 fa ff ff       	jmp    8010585e <alltraps>
...
80105e3d:	6a 00                	push   $0x0
  pushl $34
80105e3f:	6a 22                	push   $0x22
  jmp alltraps
80105e41:	e9 18 fa ff ff       	jmp    8010585e <alltraps>
...
80105e46:	6a 00                	push   $0x0
  pushl $35
80105e48:	6a 23                	push   $0x23
  jmp alltraps
80105e4a:	e9 0f fa ff ff       	jmp    8010585e <alltraps>
...
80105e4f:	6a 00                	push   $0x0
  pushl $36
80105e51:	6a 24                	push   $0x24
  jmp alltraps
80105e53:	e9 06 fa ff ff       	jmp    8010585e <alltraps>
...
80105e58:	6a 00                	push   $0x0
  pushl $37
80105e5a:	6a 25                	push   $0x25
  jmp alltraps
80105e5c:	e9 fd f9 ff ff       	jmp    8010585e <alltraps>
...
80105e61:	6a 00                	push   $0x0
  pushl $38
80105e63:	6a 26                	push   $0x26
  jmp alltraps
80105e65:	e9 f4 f9 ff ff       	jmp    8010585e <alltraps>
...
80105e6a:	6a 00                	push   $0x0
  pushl $39
80105e6c:	6a 27                	push   $0x27
  jmp alltraps
80105e6e:	e9 eb f9 ff ff       	jmp    8010585e <alltraps>
...
80105e73:	6a 00                	push   $0x0
  pushl $40
80105e75:	6a 28                	push   $0x28
  jmp alltraps
80105e77:	e9 e2 f9 ff ff       	jmp    8010585e <alltraps>
...
80105e7c:	6a 00                	push   $0x0
  pushl $41
80105e7e:	6a 29                	push   $0x29
  jmp alltraps
80105e80:	e9 d9 f9 ff ff       	jmp    8010585e <alltraps>
...
80105e85:	6a 00                	push   $0x0
  pushl $42
80105e87:	6a 2a                	push   $0x2a
  jmp alltraps
80105e89:	e9 d0 f9 ff ff       	jmp    8010585e <alltraps>
...
80105e8e:	6a 00                	push   $0x0
  pushl $43
80105e90:	6a 2b                	push   $0x2b
  jmp alltraps
80105e92:	e9 c7 f9 ff ff       	jmp    8010585e <alltraps>
...
80105e97:	6a 00                	push   $0x0
  pushl $44
80105e99:	6a 2c                	push   $0x2c
  jmp alltraps
80105e9b:	e9 be f9 ff ff       	jmp    8010585e <alltraps>
...
80105ea0:	6a 00                	push   $0x0
  pushl $45
80105ea2:	6a 2d                	push   $0x2d
  jmp alltraps
80105ea4:	e9 b5 f9 ff ff       	jmp    8010585e <alltraps>
...
80105ea9:	6a 00                	push   $0x0
  pushl $46
80105eab:	6a 2e                	push   $0x2e
  jmp alltraps
80105ead:	e9 ac f9 ff ff       	jmp    8010585e <alltraps>
...
80105eb2:	6a 00                	push   $0x0
  pushl $47
80105eb4:	6a 2f                	push   $0x2f
  jmp alltraps
80105eb6:	e9 a3 f9 ff ff       	jmp    8010585e <alltraps>
...
80105ebb:	6a 00                	push   $0x0
  pushl $48
80105ebd:	6a 30                	push   $0x30
  jmp alltraps
80105ebf:	e9 9a f9 ff ff       	jmp    8010585e <alltraps>
...
80105ec4:	6a 00                	push   $0x0
  pushl $49
80105ec6:	6a 31                	push   $0x31
  jmp alltraps
80105ec8:	e9 91 f9 ff ff       	jmp    8010585e <alltraps>
...
80105ecd:	6a 00                	push   $0x0
  pushl $50
80105ecf:	6a 32                	push   $0x32
  jmp alltraps
80105ed1:	e9 88 f9 ff ff       	jmp    8010585e <alltraps>
...
80105ed6:	6a 00                	push   $0x0
  pushl $51
80105ed8:	6a 33                	push   $0x33
  jmp alltraps
80105eda:	e9 7f f9 ff ff       	jmp    8010585e <alltraps>
...
80105edf:	6a 00                	push   $0x0
  pushl $52
80105ee1:	6a 34                	push   $0x34
  jmp alltraps
80105ee3:	e9 76 f9 ff ff       	jmp    8010585e <alltraps>
...
80105ee8:	6a 00                	push   $0x0
  pushl $53
80105eea:	6a 35                	push   $0x35
  jmp alltraps
80105eec:	e9 6d f9 ff ff       	jmp    8010585e <alltraps>
...
80105ef1:	6a 00                	push   $0x0
  pushl $54
80105ef3:	6a 36                	push   $0x36
  jmp alltraps
80105ef5:	e9 64 f9 ff ff       	jmp    8010585e <alltraps>
...
80105efa:	6a 00                	push   $0x0
  pushl $55
80105efc:	6a 37                	push   $0x37
  jmp alltraps
80105efe:	e9 5b f9 ff ff       	jmp    8010585e <alltraps>
...
80105f03:	6a 00                	push   $0x0
  pushl $56
80105f05:	6a 38                	push   $0x38
  jmp alltraps
80105f07:	e9 52 f9 ff ff       	jmp    8010585e <alltraps>
...
80105f0c:	6a 00                	push   $0x0
  pushl $57
80105f0e:	6a 39                	push   $0x39
  jmp alltraps
80105f10:	e9 49 f9 ff ff       	jmp    8010585e <alltraps>
...
80105f15:	6a 00                	push   $0x0
  pushl $58
80105f17:	6a 3a                	push   $0x3a
  jmp alltraps
80105f19:	e9 40 f9 ff ff       	jmp    8010585e <alltraps>
...
80105f1e:	6a 00                	push   $0x0
  pushl $59
80105f20:	6a 3b                	push   $0x3b
  jmp alltraps
80105f22:	e9 37 f9 ff ff       	jmp    8010585e <alltraps>
...
80105f27:	6a 00                	push   $0x0
  pushl $60
80105f29:	6a 3c                	push   $0x3c
  jmp alltraps
80105f2b:	e9 2e f9 ff ff       	jmp    8010585e <alltraps>
...
80105f30:	6a 00                	push   $0x0
  pushl $61
80105f32:	6a 3d                	push   $0x3d
  jmp alltraps
80105f34:	e9 25 f9 ff ff       	jmp    8010585e <alltraps>
...
80105f39:	6a 00                	push   $0x0
  pushl $62
80105f3b:	6a 3e                	push   $0x3e
  jmp alltraps
80105f3d:	e9 1c f9 ff ff       	jmp    8010585e <alltraps>
...
80105f42:	6a 00                	push   $0x0
  pushl $63
80105f44:	6a 3f                	push   $0x3f
  jmp alltraps
80105f46:	e9 13 f9 ff ff       	jmp    8010585e <alltraps>
...
80105f4b:	6a 00                	push   $0x0
  pushl $64
80105f4d:	6a 40                	push   $0x40
  jmp alltraps
80105f4f:	e9 0a f9 ff ff       	jmp    8010585e <alltraps>
...
80105f54:	6a 00                	push   $0x0
  pushl $65
80105f56:	6a 41                	push   $0x41
  jmp alltraps
80105f58:	e9 01 f9 ff ff       	jmp    8010585e <alltraps>
...
80105f5d:	6a 00                	push   $0x0
  pushl $66
80105f5f:	6a 42                	push   $0x42
  jmp alltraps
80105f61:	e9 f8 f8 ff ff       	jmp    8010585e <alltraps>
...
80105f66:	6a 00                	push   $0x0
  pushl $67
80105f68:	6a 43                	push   $0x43
  jmp alltraps
80105f6a:	e9 ef f8 ff ff       	jmp    8010585e <alltraps>
...
80105f6f:	6a 00                	push   $0x0
  pushl $68
80105f71:	6a 44                	push   $0x44
  jmp alltraps
80105f73:	e9 e6 f8 ff ff       	jmp    8010585e <alltraps>
...
80105f78:	6a 00                	push   $0x0
  pushl $69
80105f7a:	6a 45                	push   $0x45
  jmp alltraps
80105f7c:	e9 dd f8 ff ff       	jmp    8010585e <alltraps>
...
80105f81:	6a 00                	push   $0x0
  pushl $70
80105f83:	6a 46                	push   $0x46
  jmp alltraps
80105f85:	e9 d4 f8 ff ff       	jmp    8010585e <alltraps>
...
80105f8a:	6a 00                	push   $0x0
  pushl $71
80105f8c:	6a 47                	push   $0x47
  jmp alltraps
80105f8e:	e9 cb f8 ff ff       	jmp    8010585e <alltraps>
...
80105f93:	6a 00                	push   $0x0
  pushl $72
80105f95:	6a 48                	push   $0x48
  jmp alltraps
80105f97:	e9 c2 f8 ff ff       	jmp    8010585e <alltraps>
...
80105f9c:	6a 00                	push   $0x0
  pushl $73
80105f9e:	6a 49                	push   $0x49
  jmp alltraps
80105fa0:	e9 b9 f8 ff ff       	jmp    8010585e <alltraps>
...
80105fa5:	6a 00                	push   $0x0
  pushl $74
80105fa7:	6a 4a                	push   $0x4a
  jmp alltraps
80105fa9:	e9 b0 f8 ff ff       	jmp    8010585e <alltraps>
...
80105fae:	6a 00                	push   $0x0
  pushl $75
80105fb0:	6a 4b                	push   $0x4b
  jmp alltraps
80105fb2:	e9 a7 f8 ff ff       	jmp    8010585e <alltraps>
...
80105fb7:	6a 00                	push   $0x0
  pushl $76
80105fb9:	6a 4c                	push   $0x4c
  jmp alltraps
80105fbb:	e9 9e f8 ff ff       	jmp    8010585e <alltraps>
...
80105fc0:	6a 00                	push   $0x0
  pushl $77
80105fc2:	6a 4d                	push   $0x4d
  jmp alltraps
80105fc4:	e9 95 f8 ff ff       	jmp    8010585e <alltraps>
...
80105fc9:	6a 00                	push   $0x0
  pushl $78
80105fcb:	6a 4e                	push   $0x4e
  jmp alltraps
80105fcd:	e9 8c f8 ff ff       	jmp    8010585e <alltraps>
...
80105fd2:	6a 00                	push   $0x0
  pushl $79
80105fd4:	6a 4f                	push   $0x4f
  jmp alltraps
80105fd6:	e9 83 f8 ff ff       	jmp    8010585e <alltraps>
...
80105fdb:	6a 00                	push   $0x0
  pushl $80
80105fdd:	6a 50                	push   $0x50
  jmp alltraps
80105fdf:	e9 7a f8 ff ff       	jmp    8010585e <alltraps>
...
80105fe4:	6a 00                	push   $0x0
  pushl $81
80105fe6:	6a 51                	push   $0x51
  jmp alltraps
80105fe8:	e9 71 f8 ff ff       	jmp    8010585e <alltraps>
...
80105fed:	6a 00                	push   $0x0
  pushl $82
80105fef:	6a 52                	push   $0x52
  jmp alltraps
80105ff1:	e9 68 f8 ff ff       	jmp    8010585e <alltraps>
...
80105ff6:	6a 00                	push   $0x0
  pushl $83
80105ff8:	6a 53                	push   $0x53
  jmp alltraps
80105ffa:	e9 5f f8 ff ff       	jmp    8010585e <alltraps>
...
80105fff:	6a 00                	push   $0x0
  pushl $84
80106001:	6a 54                	push   $0x54
  jmp alltraps
80106003:	e9 56 f8 ff ff       	jmp    8010585e <alltraps>
...
80106008:	6a 00                	push   $0x0
  pushl $85
8010600a:	6a 55                	push   $0x55
  jmp alltraps
8010600c:	e9 4d f8 ff ff       	jmp    8010585e <alltraps>
...
80106011:	6a 00                	push   $0x0
  pushl $86
80106013:	6a 56                	push   $0x56
  jmp alltraps
80106015:	e9 44 f8 ff ff       	jmp    8010585e <alltraps>
...
8010601a:	6a 00                	push   $0x0
  pushl $87
8010601c:	6a 57                	push   $0x57
  jmp alltraps
8010601e:	e9 3b f8 ff ff       	jmp    8010585e <alltraps>
...
80106023:	6a 00                	push   $0x0
  pushl $88
80106025:	6a 58                	push   $0x58
  jmp alltraps
80106027:	e9 32 f8 ff ff       	jmp    8010585e <alltraps>
...
8010602c:	6a 00                	push   $0x0
  pushl $89
8010602e:	6a 59                	push   $0x59
  jmp alltraps
80106030:	e9 29 f8 ff ff       	jmp    8010585e <alltraps>
...
80106035:	6a 00                	push   $0x0
  pushl $90
80106037:	6a 5a                	push   $0x5a
  jmp alltraps
80106039:	e9 20 f8 ff ff       	jmp    8010585e <alltraps>
...
8010603e:	6a 00                	push   $0x0
  pushl $91
80106040:	6a 5b                	push   $0x5b
  jmp alltraps
80106042:	e9 17 f8 ff ff       	jmp    8010585e <alltraps>
...
80106047:	6a 00                	push   $0x0
  pushl $92
80106049:	6a 5c                	push   $0x5c
  jmp alltraps
8010604b:	e9 0e f8 ff ff       	jmp    8010585e <alltraps>
...
80106050:	6a 00                	push   $0x0
  pushl $93
80106052:	6a 5d                	push   $0x5d
  jmp alltraps
80106054:	e9 05 f8 ff ff       	jmp    8010585e <alltraps>
...
80106059:	6a 00                	push   $0x0
  pushl $94
8010605b:	6a 5e                	push   $0x5e
  jmp alltraps
8010605d:	e9 fc f7 ff ff       	jmp    8010585e <alltraps>
...
80106062:	6a 00                	push   $0x0
  pushl $95
80106064:	6a 5f                	push   $0x5f
  jmp alltraps
80106066:	e9 f3 f7 ff ff       	jmp    8010585e <alltraps>
...
8010606b:	6a 00                	push   $0x0
  pushl $96
8010606d:	6a 60                	push   $0x60
  jmp alltraps
8010606f:	e9 ea f7 ff ff       	jmp    8010585e <alltraps>
...
80106074:	6a 00                	push   $0x0
  pushl $97
80106076:	6a 61                	push   $0x61
  jmp alltraps
80106078:	e9 e1 f7 ff ff       	jmp    8010585e <alltraps>
...
8010607d:	6a 00                	push   $0x0
  pushl $98
8010607f:	6a 62                	push   $0x62
  jmp alltraps
80106081:	e9 d8 f7 ff ff       	jmp    8010585e <alltraps>
...
80106086:	6a 00                	push   $0x0
  pushl $99
80106088:	6a 63                	push   $0x63
  jmp alltraps
8010608a:	e9 cf f7 ff ff       	jmp    8010585e <alltraps>
...
8010608f:	6a 00                	push   $0x0
  pushl $100
80106091:	6a 64                	push   $0x64
  jmp alltraps
80106093:	e9 c6 f7 ff ff       	jmp    8010585e <alltraps>
...
80106098:	6a 00                	push   $0x0
  pushl $101
8010609a:	6a 65                	push   $0x65
  jmp alltraps
8010609c:	e9 bd f7 ff ff       	jmp    8010585e <alltraps>
...
801060a1:	6a 00                	push   $0x0
  pushl $102
801060a3:	6a 66                	push   $0x66
  jmp alltraps
801060a5:	e9 b4 f7 ff ff       	jmp    8010585e <alltraps>
...
801060aa:	6a 00                	push   $0x0
  pushl $103
801060ac:	6a 67                	push   $0x67
  jmp alltraps
801060ae:	e9 ab f7 ff ff       	jmp    8010585e <alltraps>
...
801060b3:	6a 00                	push   $0x0
  pushl $104
801060b5:	6a 68                	push   $0x68
  jmp alltraps
801060b7:	e9 a2 f7 ff ff       	jmp    8010585e <alltraps>
...
801060bc:	6a 00                	push   $0x0
  pushl $105
801060be:	6a 69                	push   $0x69
  jmp alltraps
801060c0:	e9 99 f7 ff ff       	jmp    8010585e <alltraps>
...
801060c5:	6a 00                	push   $0x0
  pushl $106
801060c7:	6a 6a                	push   $0x6a
  jmp alltraps
801060c9:	e9 90 f7 ff ff       	jmp    8010585e <alltraps>
...
801060ce:	6a 00                	push   $0x0
  pushl $107
801060d0:	6a 6b                	push   $0x6b
  jmp alltraps
801060d2:	e9 87 f7 ff ff       	jmp    8010585e <alltraps>
...
801060d7:	6a 00                	push   $0x0
  pushl $108
801060d9:	6a 6c                	push   $0x6c
  jmp alltraps
801060db:	e9 7e f7 ff ff       	jmp    8010585e <alltraps>
...
801060e0:	6a 00                	push   $0x0
  pushl $109
801060e2:	6a 6d                	push   $0x6d
  jmp alltraps
801060e4:	e9 75 f7 ff ff       	jmp    8010585e <alltraps>
...
801060e9:	6a 00                	push   $0x0
  pushl $110
801060eb:	6a 6e                	push   $0x6e
  jmp alltraps
801060ed:	e9 6c f7 ff ff       	jmp    8010585e <alltraps>
...
801060f2:	6a 00                	push   $0x0
  pushl $111
801060f4:	6a 6f                	push   $0x6f
  jmp alltraps
801060f6:	e9 63 f7 ff ff       	jmp    8010585e <alltraps>
...
801060fb:	6a 00                	push   $0x0
  pushl $112
801060fd:	6a 70                	push   $0x70
  jmp alltraps
801060ff:	e9 5a f7 ff ff       	jmp    8010585e <alltraps>
...
80106104:	6a 00                	push   $0x0
  pushl $113
80106106:	6a 71                	push   $0x71
  jmp alltraps
80106108:	e9 51 f7 ff ff       	jmp    8010585e <alltraps>
...
8010610d:	6a 00                	push   $0x0
  pushl $114
8010610f:	6a 72                	push   $0x72
  jmp alltraps
80106111:	e9 48 f7 ff ff       	jmp    8010585e <alltraps>
...
80106116:	6a 00                	push   $0x0
  pushl $115
80106118:	6a 73                	push   $0x73
  jmp alltraps
8010611a:	e9 3f f7 ff ff       	jmp    8010585e <alltraps>
...
8010611f:	6a 00                	push   $0x0
  pushl $116
80106121:	6a 74                	push   $0x74
  jmp alltraps
80106123:	e9 36 f7 ff ff       	jmp    8010585e <alltraps>
...
80106128:	6a 00                	push   $0x0
  pushl $117
8010612a:	6a 75                	push   $0x75
  jmp alltraps
8010612c:	e9 2d f7 ff ff       	jmp    8010585e <alltraps>
...
80106131:	6a 00                	push   $0x0
  pushl $118
80106133:	6a 76                	push   $0x76
  jmp alltraps
80106135:	e9 24 f7 ff ff       	jmp    8010585e <alltraps>
...
8010613a:	6a 00                	push   $0x0
  pushl $119
8010613c:	6a 77                	push   $0x77
  jmp alltraps
8010613e:	e9 1b f7 ff ff       	jmp    8010585e <alltraps>
...
80106143:	6a 00                	push   $0x0
  pushl $120
80106145:	6a 78                	push   $0x78
  jmp alltraps
80106147:	e9 12 f7 ff ff       	jmp    8010585e <alltraps>
...
8010614c:	6a 00                	push   $0x0
  pushl $121
8010614e:	6a 79                	push   $0x79
  jmp alltraps
80106150:	e9 09 f7 ff ff       	jmp    8010585e <alltraps>
...
80106155:	6a 00                	push   $0x0
  pushl $122
80106157:	6a 7a                	push   $0x7a
  jmp alltraps
80106159:	e9 00 f7 ff ff       	jmp    8010585e <alltraps>
...
8010615e:	6a 00                	push   $0x0
  pushl $123
80106160:	6a 7b                	push   $0x7b
  jmp alltraps
80106162:	e9 f7 f6 ff ff       	jmp    8010585e <alltraps>
...
80106167:	6a 00                	push   $0x0
  pushl $124
80106169:	6a 7c                	push   $0x7c
  jmp alltraps
8010616b:	e9 ee f6 ff ff       	jmp    8010585e <alltraps>
...
80106170:	6a 00                	push   $0x0
  pushl $125
80106172:	6a 7d                	push   $0x7d
  jmp alltraps
80106174:	e9 e5 f6 ff ff       	jmp    8010585e <alltraps>
...
80106179:	6a 00                	push   $0x0
  pushl $126
8010617b:	6a 7e                	push   $0x7e
  jmp alltraps
8010617d:	e9 dc f6 ff ff       	jmp    8010585e <alltraps>
...
80106182:	6a 00                	push   $0x0
  pushl $127
80106184:	6a 7f                	push   $0x7f
  jmp alltraps
80106186:	e9 d3 f6 ff ff       	jmp    8010585e <alltraps>
...
8010618b:	6a 00                	push   $0x0
  pushl $128
8010618d:	68 80 00 00 00       	push   $0x80
  jmp alltraps
80106192:	e9 c7 f6 ff ff       	jmp    8010585e <alltraps>
...
80106197:	6a 00                	push   $0x0
  pushl $129
80106199:	68 81 00 00 00       	push   $0x81
  jmp alltraps
8010619e:	e9 bb f6 ff ff       	jmp    8010585e <alltraps>
...
801061a3:	6a 00                	push   $0x0
  pushl $130
801061a5:	68 82 00 00 00       	push   $0x82
  jmp alltraps
801061aa:	e9 af f6 ff ff       	jmp    8010585e <alltraps>
...
801061af:	6a 00                	push   $0x0
  pushl $131
801061b1:	68 83 00 00 00       	push   $0x83
  jmp alltraps
801061b6:	e9 a3 f6 ff ff       	jmp    8010585e <alltraps>
...
801061bb:	6a 00                	push   $0x0
  pushl $132
801061bd:	68 84 00 00 00       	push   $0x84
  jmp alltraps
801061c2:	e9 97 f6 ff ff       	jmp    8010585e <alltraps>
...
801061c7:	6a 00                	push   $0x0
  pushl $133
801061c9:	68 85 00 00 00       	push   $0x85
  jmp alltraps
801061ce:	e9 8b f6 ff ff       	jmp    8010585e <alltraps>
...
801061d3:	6a 00                	push   $0x0
  pushl $134
801061d5:	68 86 00 00 00       	push   $0x86
  jmp alltraps
801061da:	e9 7f f6 ff ff       	jmp    8010585e <alltraps>
...
801061df:	6a 00                	push   $0x0
  pushl $135
801061e1:	68 87 00 00 00       	push   $0x87
  jmp alltraps
801061e6:	e9 73 f6 ff ff       	jmp    8010585e <alltraps>
...
801061eb:	6a 00                	push   $0x0
  pushl $136
801061ed:	68 88 00 00 00       	push   $0x88
  jmp alltraps
801061f2:	e9 67 f6 ff ff       	jmp    8010585e <alltraps>
...
801061f7:	6a 00                	push   $0x0
  pushl $137
801061f9:	68 89 00 00 00       	push   $0x89
  jmp alltraps
801061fe:	e9 5b f6 ff ff       	jmp    8010585e <alltraps>
...
80106203:	6a 00                	push   $0x0
  pushl $138
80106205:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
8010620a:	e9 4f f6 ff ff       	jmp    8010585e <alltraps>
...
8010620f:	6a 00                	push   $0x0
  pushl $139
80106211:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80106216:	e9 43 f6 ff ff       	jmp    8010585e <alltraps>
...
8010621b:	6a 00                	push   $0x0
  pushl $140
8010621d:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
80106222:	e9 37 f6 ff ff       	jmp    8010585e <alltraps>
...
80106227:	6a 00                	push   $0x0
  pushl $141
80106229:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
8010622e:	e9 2b f6 ff ff       	jmp    8010585e <alltraps>
...
80106233:	6a 00                	push   $0x0
  pushl $142
80106235:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
8010623a:	e9 1f f6 ff ff       	jmp    8010585e <alltraps>
...
8010623f:	6a 00                	push   $0x0
  pushl $143
80106241:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
80106246:	e9 13 f6 ff ff       	jmp    8010585e <alltraps>
...
8010624b:	6a 00                	push   $0x0
  pushl $144
8010624d:	68 90 00 00 00       	push   $0x90
  jmp alltraps
80106252:	e9 07 f6 ff ff       	jmp    8010585e <alltraps>
...
80106257:	6a 00                	push   $0x0
  pushl $145
80106259:	68 91 00 00 00       	push   $0x91
  jmp alltraps
8010625e:	e9 fb f5 ff ff       	jmp    8010585e <alltraps>
...
80106263:	6a 00                	push   $0x0
  pushl $146
80106265:	68 92 00 00 00       	push   $0x92
  jmp alltraps
8010626a:	e9 ef f5 ff ff       	jmp    8010585e <alltraps>
...
8010626f:	6a 00                	push   $0x0
  pushl $147
80106271:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80106276:	e9 e3 f5 ff ff       	jmp    8010585e <alltraps>
...
8010627b:	6a 00                	push   $0x0
  pushl $148
8010627d:	68 94 00 00 00       	push   $0x94
  jmp alltraps
80106282:	e9 d7 f5 ff ff       	jmp    8010585e <alltraps>
...
80106287:	6a 00                	push   $0x0
  pushl $149
80106289:	68 95 00 00 00       	push   $0x95
  jmp alltraps
8010628e:	e9 cb f5 ff ff       	jmp    8010585e <alltraps>
...
80106293:	6a 00                	push   $0x0
  pushl $150
80106295:	68 96 00 00 00       	push   $0x96
  jmp alltraps
8010629a:	e9 bf f5 ff ff       	jmp    8010585e <alltraps>
...
8010629f:	6a 00                	push   $0x0
  pushl $151
801062a1:	68 97 00 00 00       	push   $0x97
  jmp alltraps
801062a6:	e9 b3 f5 ff ff       	jmp    8010585e <alltraps>
...
801062ab:	6a 00                	push   $0x0
  pushl $152
801062ad:	68 98 00 00 00       	push   $0x98
  jmp alltraps
801062b2:	e9 a7 f5 ff ff       	jmp    8010585e <alltraps>
...
801062b7:	6a 00                	push   $0x0
  pushl $153
801062b9:	68 99 00 00 00       	push   $0x99
  jmp alltraps
801062be:	e9 9b f5 ff ff       	jmp    8010585e <alltraps>
...
801062c3:	6a 00                	push   $0x0
  pushl $154
801062c5:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
801062ca:	e9 8f f5 ff ff       	jmp    8010585e <alltraps>
...
801062cf:	6a 00                	push   $0x0
  pushl $155
801062d1:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
801062d6:	e9 83 f5 ff ff       	jmp    8010585e <alltraps>
...
801062db:	6a 00                	push   $0x0
  pushl $156
801062dd:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
801062e2:	e9 77 f5 ff ff       	jmp    8010585e <alltraps>
...
801062e7:	6a 00                	push   $0x0
  pushl $157
801062e9:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
801062ee:	e9 6b f5 ff ff       	jmp    8010585e <alltraps>
...
801062f3:	6a 00                	push   $0x0
  pushl $158
801062f5:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
801062fa:	e9 5f f5 ff ff       	jmp    8010585e <alltraps>
...
801062ff:	6a 00                	push   $0x0
  pushl $159
80106301:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80106306:	e9 53 f5 ff ff       	jmp    8010585e <alltraps>
...
8010630b:	6a 00                	push   $0x0
  pushl $160
8010630d:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
80106312:	e9 47 f5 ff ff       	jmp    8010585e <alltraps>
...
80106317:	6a 00                	push   $0x0
  pushl $161
80106319:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
8010631e:	e9 3b f5 ff ff       	jmp    8010585e <alltraps>
...
80106323:	6a 00                	push   $0x0
  pushl $162
80106325:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
8010632a:	e9 2f f5 ff ff       	jmp    8010585e <alltraps>
...
8010632f:	6a 00                	push   $0x0
  pushl $163
80106331:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80106336:	e9 23 f5 ff ff       	jmp    8010585e <alltraps>
...
8010633b:	6a 00                	push   $0x0
  pushl $164
8010633d:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
80106342:	e9 17 f5 ff ff       	jmp    8010585e <alltraps>
...
80106347:	6a 00                	push   $0x0
  pushl $165
80106349:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
8010634e:	e9 0b f5 ff ff       	jmp    8010585e <alltraps>
...
80106353:	6a 00                	push   $0x0
  pushl $166
80106355:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
8010635a:	e9 ff f4 ff ff       	jmp    8010585e <alltraps>
...
8010635f:	6a 00                	push   $0x0
  pushl $167
80106361:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
80106366:	e9 f3 f4 ff ff       	jmp    8010585e <alltraps>
...
8010636b:	6a 00                	push   $0x0
  pushl $168
8010636d:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
80106372:	e9 e7 f4 ff ff       	jmp    8010585e <alltraps>
...
80106377:	6a 00                	push   $0x0
  pushl $169
80106379:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
8010637e:	e9 db f4 ff ff       	jmp    8010585e <alltraps>
...
80106383:	6a 00                	push   $0x0
  pushl $170
80106385:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
8010638a:	e9 cf f4 ff ff       	jmp    8010585e <alltraps>
...
8010638f:	6a 00                	push   $0x0
  pushl $171
80106391:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80106396:	e9 c3 f4 ff ff       	jmp    8010585e <alltraps>
...
8010639b:	6a 00                	push   $0x0
  pushl $172
8010639d:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
801063a2:	e9 b7 f4 ff ff       	jmp    8010585e <alltraps>
...
801063a7:	6a 00                	push   $0x0
  pushl $173
801063a9:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
801063ae:	e9 ab f4 ff ff       	jmp    8010585e <alltraps>
...
801063b3:	6a 00                	push   $0x0
  pushl $174
801063b5:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
801063ba:	e9 9f f4 ff ff       	jmp    8010585e <alltraps>
...
801063bf:	6a 00                	push   $0x0
  pushl $175
801063c1:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
801063c6:	e9 93 f4 ff ff       	jmp    8010585e <alltraps>
...
801063cb:	6a 00                	push   $0x0
  pushl $176
801063cd:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
801063d2:	e9 87 f4 ff ff       	jmp    8010585e <alltraps>
...
801063d7:	6a 00                	push   $0x0
  pushl $177
801063d9:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
801063de:	e9 7b f4 ff ff       	jmp    8010585e <alltraps>
...
801063e3:	6a 00                	push   $0x0
  pushl $178
801063e5:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
801063ea:	e9 6f f4 ff ff       	jmp    8010585e <alltraps>
...
801063ef:	6a 00                	push   $0x0
  pushl $179
801063f1:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
801063f6:	e9 63 f4 ff ff       	jmp    8010585e <alltraps>
...
801063fb:	6a 00                	push   $0x0
  pushl $180
801063fd:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
80106402:	e9 57 f4 ff ff       	jmp    8010585e <alltraps>
...
80106407:	6a 00                	push   $0x0
  pushl $181
80106409:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
8010640e:	e9 4b f4 ff ff       	jmp    8010585e <alltraps>
...
80106413:	6a 00                	push   $0x0
  pushl $182
80106415:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
8010641a:	e9 3f f4 ff ff       	jmp    8010585e <alltraps>
...
8010641f:	6a 00                	push   $0x0
  pushl $183
80106421:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80106426:	e9 33 f4 ff ff       	jmp    8010585e <alltraps>
...
8010642b:	6a 00                	push   $0x0
  pushl $184
8010642d:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
80106432:	e9 27 f4 ff ff       	jmp    8010585e <alltraps>
...
80106437:	6a 00                	push   $0x0
  pushl $185
80106439:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
8010643e:	e9 1b f4 ff ff       	jmp    8010585e <alltraps>
...
80106443:	6a 00                	push   $0x0
  pushl $186
80106445:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
8010644a:	e9 0f f4 ff ff       	jmp    8010585e <alltraps>
...
8010644f:	6a 00                	push   $0x0
  pushl $187
80106451:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
80106456:	e9 03 f4 ff ff       	jmp    8010585e <alltraps>
...
8010645b:	6a 00                	push   $0x0
  pushl $188
8010645d:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
80106462:	e9 f7 f3 ff ff       	jmp    8010585e <alltraps>
...
80106467:	6a 00                	push   $0x0
  pushl $189
80106469:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
8010646e:	e9 eb f3 ff ff       	jmp    8010585e <alltraps>
...
80106473:	6a 00                	push   $0x0
  pushl $190
80106475:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
8010647a:	e9 df f3 ff ff       	jmp    8010585e <alltraps>
...
8010647f:	6a 00                	push   $0x0
  pushl $191
80106481:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
80106486:	e9 d3 f3 ff ff       	jmp    8010585e <alltraps>
...
8010648b:	6a 00                	push   $0x0
  pushl $192
8010648d:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
80106492:	e9 c7 f3 ff ff       	jmp    8010585e <alltraps>
...
80106497:	6a 00                	push   $0x0
  pushl $193
80106499:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
8010649e:	e9 bb f3 ff ff       	jmp    8010585e <alltraps>
...
801064a3:	6a 00                	push   $0x0
  pushl $194
801064a5:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
801064aa:	e9 af f3 ff ff       	jmp    8010585e <alltraps>
...
801064af:	6a 00                	push   $0x0
  pushl $195
801064b1:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
801064b6:	e9 a3 f3 ff ff       	jmp    8010585e <alltraps>
...
801064bb:	6a 00                	push   $0x0
  pushl $196
801064bd:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
801064c2:	e9 97 f3 ff ff       	jmp    8010585e <alltraps>
...
801064c7:	6a 00                	push   $0x0
  pushl $197
801064c9:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
801064ce:	e9 8b f3 ff ff       	jmp    8010585e <alltraps>
...
801064d3:	6a 00                	push   $0x0
  pushl $198
801064d5:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
801064da:	e9 7f f3 ff ff       	jmp    8010585e <alltraps>
...
801064df:	6a 00                	push   $0x0
  pushl $199
801064e1:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
801064e6:	e9 73 f3 ff ff       	jmp    8010585e <alltraps>
...
801064eb:	6a 00                	push   $0x0
  pushl $200
801064ed:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
801064f2:	e9 67 f3 ff ff       	jmp    8010585e <alltraps>
...
801064f7:	6a 00                	push   $0x0
  pushl $201
801064f9:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
801064fe:	e9 5b f3 ff ff       	jmp    8010585e <alltraps>
...
80106503:	6a 00                	push   $0x0
  pushl $202
80106505:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
8010650a:	e9 4f f3 ff ff       	jmp    8010585e <alltraps>
...
8010650f:	6a 00                	push   $0x0
  pushl $203
80106511:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80106516:	e9 43 f3 ff ff       	jmp    8010585e <alltraps>
...
8010651b:	6a 00                	push   $0x0
  pushl $204
8010651d:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
80106522:	e9 37 f3 ff ff       	jmp    8010585e <alltraps>
...
80106527:	6a 00                	push   $0x0
  pushl $205
80106529:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
8010652e:	e9 2b f3 ff ff       	jmp    8010585e <alltraps>
...
80106533:	6a 00                	push   $0x0
  pushl $206
80106535:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
8010653a:	e9 1f f3 ff ff       	jmp    8010585e <alltraps>
...
8010653f:	6a 00                	push   $0x0
  pushl $207
80106541:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
80106546:	e9 13 f3 ff ff       	jmp    8010585e <alltraps>
...
8010654b:	6a 00                	push   $0x0
  pushl $208
8010654d:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
80106552:	e9 07 f3 ff ff       	jmp    8010585e <alltraps>
...
80106557:	6a 00                	push   $0x0
  pushl $209
80106559:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
8010655e:	e9 fb f2 ff ff       	jmp    8010585e <alltraps>
...
80106563:	6a 00                	push   $0x0
  pushl $210
80106565:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
8010656a:	e9 ef f2 ff ff       	jmp    8010585e <alltraps>
...
8010656f:	6a 00                	push   $0x0
  pushl $211
80106571:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80106576:	e9 e3 f2 ff ff       	jmp    8010585e <alltraps>
...
8010657b:	6a 00                	push   $0x0
  pushl $212
8010657d:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
80106582:	e9 d7 f2 ff ff       	jmp    8010585e <alltraps>
...
80106587:	6a 00                	push   $0x0
  pushl $213
80106589:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
8010658e:	e9 cb f2 ff ff       	jmp    8010585e <alltraps>
...
80106593:	6a 00                	push   $0x0
  pushl $214
80106595:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
8010659a:	e9 bf f2 ff ff       	jmp    8010585e <alltraps>
...
8010659f:	6a 00                	push   $0x0
  pushl $215
801065a1:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
801065a6:	e9 b3 f2 ff ff       	jmp    8010585e <alltraps>
...
801065ab:	6a 00                	push   $0x0
  pushl $216
801065ad:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
801065b2:	e9 a7 f2 ff ff       	jmp    8010585e <alltraps>
...
801065b7:	6a 00                	push   $0x0
  pushl $217
801065b9:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
801065be:	e9 9b f2 ff ff       	jmp    8010585e <alltraps>
...
801065c3:	6a 00                	push   $0x0
  pushl $218
801065c5:	68 da 00 00 00       	push   $0xda
  jmp alltraps
801065ca:	e9 8f f2 ff ff       	jmp    8010585e <alltraps>
...
801065cf:	6a 00                	push   $0x0
  pushl $219
801065d1:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
801065d6:	e9 83 f2 ff ff       	jmp    8010585e <alltraps>
...
801065db:	6a 00                	push   $0x0
  pushl $220
801065dd:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
801065e2:	e9 77 f2 ff ff       	jmp    8010585e <alltraps>
...
801065e7:	6a 00                	push   $0x0
  pushl $221
801065e9:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
801065ee:	e9 6b f2 ff ff       	jmp    8010585e <alltraps>
...
801065f3:	6a 00                	push   $0x0
  pushl $222
801065f5:	68 de 00 00 00       	push   $0xde
  jmp alltraps
801065fa:	e9 5f f2 ff ff       	jmp    8010585e <alltraps>
...
801065ff:	6a 00                	push   $0x0
  pushl $223
80106601:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80106606:	e9 53 f2 ff ff       	jmp    8010585e <alltraps>
...
8010660b:	6a 00                	push   $0x0
  pushl $224
8010660d:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
80106612:	e9 47 f2 ff ff       	jmp    8010585e <alltraps>
...
80106617:	6a 00                	push   $0x0
  pushl $225
80106619:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
8010661e:	e9 3b f2 ff ff       	jmp    8010585e <alltraps>
...
80106623:	6a 00                	push   $0x0
  pushl $226
80106625:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
8010662a:	e9 2f f2 ff ff       	jmp    8010585e <alltraps>
...
8010662f:	6a 00                	push   $0x0
  pushl $227
80106631:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80106636:	e9 23 f2 ff ff       	jmp    8010585e <alltraps>
...
8010663b:	6a 00                	push   $0x0
  pushl $228
8010663d:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
80106642:	e9 17 f2 ff ff       	jmp    8010585e <alltraps>
...
80106647:	6a 00                	push   $0x0
  pushl $229
80106649:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
8010664e:	e9 0b f2 ff ff       	jmp    8010585e <alltraps>
...
80106653:	6a 00                	push   $0x0
  pushl $230
80106655:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
8010665a:	e9 ff f1 ff ff       	jmp    8010585e <alltraps>
...
8010665f:	6a 00                	push   $0x0
  pushl $231
80106661:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80106666:	e9 f3 f1 ff ff       	jmp    8010585e <alltraps>
...
8010666b:	6a 00                	push   $0x0
  pushl $232
8010666d:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
80106672:	e9 e7 f1 ff ff       	jmp    8010585e <alltraps>
...
80106677:	6a 00                	push   $0x0
  pushl $233
80106679:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
8010667e:	e9 db f1 ff ff       	jmp    8010585e <alltraps>
...
80106683:	6a 00                	push   $0x0
  pushl $234
80106685:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
8010668a:	e9 cf f1 ff ff       	jmp    8010585e <alltraps>
...
8010668f:	6a 00                	push   $0x0
  pushl $235
80106691:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80106696:	e9 c3 f1 ff ff       	jmp    8010585e <alltraps>
...
8010669b:	6a 00                	push   $0x0
  pushl $236
8010669d:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
801066a2:	e9 b7 f1 ff ff       	jmp    8010585e <alltraps>
...
801066a7:	6a 00                	push   $0x0
  pushl $237
801066a9:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
801066ae:	e9 ab f1 ff ff       	jmp    8010585e <alltraps>
...
801066b3:	6a 00                	push   $0x0
  pushl $238
801066b5:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
801066ba:	e9 9f f1 ff ff       	jmp    8010585e <alltraps>
...
801066bf:	6a 00                	push   $0x0
  pushl $239
801066c1:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
801066c6:	e9 93 f1 ff ff       	jmp    8010585e <alltraps>
...
801066cb:	6a 00                	push   $0x0
  pushl $240
801066cd:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
801066d2:	e9 87 f1 ff ff       	jmp    8010585e <alltraps>
...
801066d7:	6a 00                	push   $0x0
  pushl $241
801066d9:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
801066de:	e9 7b f1 ff ff       	jmp    8010585e <alltraps>
...
801066e3:	6a 00                	push   $0x0
  pushl $242
801066e5:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
801066ea:	e9 6f f1 ff ff       	jmp    8010585e <alltraps>
...
801066ef:	6a 00                	push   $0x0
  pushl $243
801066f1:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
801066f6:	e9 63 f1 ff ff       	jmp    8010585e <alltraps>
...
801066fb:	6a 00                	push   $0x0
  pushl $244
801066fd:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
80106702:	e9 57 f1 ff ff       	jmp    8010585e <alltraps>
...
80106707:	6a 00                	push   $0x0
  pushl $245
80106709:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
8010670e:	e9 4b f1 ff ff       	jmp    8010585e <alltraps>
...
80106713:	6a 00                	push   $0x0
  pushl $246
80106715:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
8010671a:	e9 3f f1 ff ff       	jmp    8010585e <alltraps>
...
8010671f:	6a 00                	push   $0x0
  pushl $247
80106721:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80106726:	e9 33 f1 ff ff       	jmp    8010585e <alltraps>
...
8010672b:	6a 00                	push   $0x0
  pushl $248
8010672d:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
80106732:	e9 27 f1 ff ff       	jmp    8010585e <alltraps>
...
80106737:	6a 00                	push   $0x0
  pushl $249
80106739:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
8010673e:	e9 1b f1 ff ff       	jmp    8010585e <alltraps>
...
80106743:	6a 00                	push   $0x0
  pushl $250
80106745:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
8010674a:	e9 0f f1 ff ff       	jmp    8010585e <alltraps>
...
8010674f:	6a 00                	push   $0x0
  pushl $251
80106751:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80106756:	e9 03 f1 ff ff       	jmp    8010585e <alltraps>
...
8010675b:	6a 00                	push   $0x0
  pushl $252
8010675d:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
80106762:	e9 f7 f0 ff ff       	jmp    8010585e <alltraps>
...
80106767:	6a 00                	push   $0x0
  pushl $253
80106769:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
8010676e:	e9 eb f0 ff ff       	jmp    8010585e <alltraps>
...
80106773:	6a 00                	push   $0x0
  pushl $254
80106775:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
8010677a:	e9 df f0 ff ff       	jmp    8010585e <alltraps>
...
8010677f:	6a 00                	push   $0x0
  pushl $255
80106781:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80106786:	e9 d3 f0 ff ff       	jmp    8010585e <alltraps>
...
801067b6:	8d 65 f4             	lea    -0xc(%ebp),%esp
  return &pgtab[PTX(va)];
801067b9:	c1 e8 0a             	shr    $0xa,%eax
801067bc:	25 fc 0f 00 00       	and    $0xffc,%eax
801067c1:	01 d8                	add    %ebx,%eax
}
801067c3:	5b                   	pop    %ebx
801067c4:	5e                   	pop    %esi
801067c5:	5f                   	pop    %edi
...
801067d4:	e8 57 be ff ff       	call   80102630 <kalloc>
801067d9:	89 c3                	mov    %eax,%ebx
...
801067ea:	e8 31 de ff ff       	call   80104620 <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
...
80106816:	8d 44 0a ff          	lea    -0x1(%edx,%ecx,1),%eax
{
8010681a:	56                   	push   %esi
  last = (char*)PGROUNDDOWN(((uint)va) + size - 1);
8010681b:	25 00 f0 ff ff       	and    $0xfffff000,%eax
  a = (char*)PGROUNDDOWN((uint)va);
80106820:	89 d6                	mov    %edx,%esi
{
80106822:	53                   	push   %ebx
  a = (char*)PGROUNDDOWN((uint)va);
80106823:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
{
80106829:	83 ec 1c             	sub    $0x1c,%esp
  last = (char*)PGROUNDDOWN(((uint)va) + size - 1);
8010682c:	89 45 e0             	mov    %eax,-0x20(%ebp)
8010682f:	8b 45 08             	mov    0x8(%ebp),%eax
80106832:	29 f0                	sub    %esi,%eax
80106834:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106837:	eb 1f                	jmp    80106858 <mappages+0x48>
...
80106843:	75 45                	jne    8010688a <mappages+0x7a>
      panic("remap");
    *pte = pa | perm | PTE_P;
80106845:	0b 5d 0c             	or     0xc(%ebp),%ebx
80106848:	83 cb 01             	or     $0x1,%ebx
8010684b:	89 18                	mov    %ebx,(%eax)
    if(a == last)
8010684d:	3b 75 e0             	cmp    -0x20(%ebp),%esi
80106850:	74 2e                	je     80106880 <mappages+0x70>
      break;
    a += PGSIZE;
80106852:	81 c6 00 10 00 00    	add    $0x1000,%esi
  for(;;){
80106858:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    if((pte = walkpgdir(pgdir, a, 1)) == 0)
8010685b:	b9 01 00 00 00       	mov    $0x1,%ecx
80106860:	89 f2                	mov    %esi,%edx
80106862:	8d 1c 06             	lea    (%esi,%eax,1),%ebx
80106865:	89 f8                	mov    %edi,%eax
80106867:	e8 24 ff ff ff       	call   80106790 <walkpgdir>
8010686c:	85 c0                	test   %eax,%eax
8010686e:	75 d0                	jne    80106840 <mappages+0x30>
    pa += PGSIZE;
  }
  return 0;
}
...
8010688d:	68 8c 79 10 80       	push   $0x8010798c
...
801068e1:	e8 aa fe ff ff       	call   80106790 <walkpgdir>
...
80106943:	68 46 73 10 80       	push   $0x80107346
...
80106957:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
8010695a:	e8 e1 cf ff ff       	call   80103940 <cpuid>
  pd[0] = size-1;
...
801069e4:	a1 a4 55 11 80       	mov    0x801155a4,%eax
801069e9:	05 00 00 00 80       	add    $0x80000000,%eax
}
...
80106a0a:	83 ec 1c             	sub    $0x1c,%esp
80106a0d:	8b 75 08             	mov    0x8(%ebp),%esi
  if(p == 0)
80106a10:	85 f6                	test   %esi,%esi
80106a12:	0f 84 cb 00 00 00    	je     80106ae3 <switchuvm+0xe3>
  if(p->kstack == 0)
80106a18:	8b 46 0c             	mov    0xc(%esi),%eax
80106a1b:	85 c0                	test   %eax,%eax
80106a1d:	0f 84 da 00 00 00    	je     80106afd <switchuvm+0xfd>
  if(p->pgdir == 0)
80106a23:	8b 46 08             	mov    0x8(%esi),%eax
80106a26:	85 c0                	test   %eax,%eax
80106a28:	0f 84 c2 00 00 00    	je     80106af0 <switchuvm+0xf0>
  pushcli();
80106a2e:	e8 dd d9 ff ff       	call   80104410 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
80106a33:	e8 98 ce ff ff       	call   801038d0 <mycpu>
80106a38:	89 c3                	mov    %eax,%ebx
80106a3a:	e8 91 ce ff ff       	call   801038d0 <mycpu>
80106a3f:	89 c7                	mov    %eax,%edi
80106a41:	e8 8a ce ff ff       	call   801038d0 <mycpu>
80106a46:	83 c7 08             	add    $0x8,%edi
80106a49:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106a4c:	e8 7f ce ff ff       	call   801038d0 <mycpu>
80106a51:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
80106a54:	ba 67 00 00 00       	mov    $0x67,%edx
80106a59:	66 89 bb 9a 00 00 00 	mov    %di,0x9a(%ebx)
80106a60:	83 c0 08             	add    $0x8,%eax
80106a63:	66 89 93 98 00 00 00 	mov    %dx,0x98(%ebx)
  mycpu()->ts.iomb = (ushort) 0xFFFF;
80106a6a:	bf ff ff ff ff       	mov    $0xffffffff,%edi
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
80106a6f:	83 c1 08             	add    $0x8,%ecx
80106a72:	c1 e8 18             	shr    $0x18,%eax
80106a75:	c1 e9 10             	shr    $0x10,%ecx
80106a78:	88 83 9f 00 00 00    	mov    %al,0x9f(%ebx)
80106a7e:	88 8b 9c 00 00 00    	mov    %cl,0x9c(%ebx)
80106a84:	b9 99 40 00 00       	mov    $0x4099,%ecx
80106a89:	66 89 8b 9d 00 00 00 	mov    %cx,0x9d(%ebx)
  mycpu()->ts.ss0 = SEG_KDATA << 3;
80106a90:	bb 10 00 00 00       	mov    $0x10,%ebx
  mycpu()->gdt[SEG_TSS].s = 0;
80106a95:	e8 36 ce ff ff       	call   801038d0 <mycpu>
80106a9a:	80 a0 9d 00 00 00 ef 	andb   $0xef,0x9d(%eax)
  mycpu()->ts.ss0 = SEG_KDATA << 3;
80106aa1:	e8 2a ce ff ff       	call   801038d0 <mycpu>
80106aa6:	66 89 58 10          	mov    %bx,0x10(%eax)
  mycpu()->ts.esp0 = (uint)p->kstack + KSTACKSIZE;
80106aaa:	8b 5e 0c             	mov    0xc(%esi),%ebx
80106aad:	81 c3 00 10 00 00    	add    $0x1000,%ebx
80106ab3:	e8 18 ce ff ff       	call   801038d0 <mycpu>
80106ab8:	89 58 0c             	mov    %ebx,0xc(%eax)
  mycpu()->ts.iomb = (ushort) 0xFFFF;
80106abb:	e8 10 ce ff ff       	call   801038d0 <mycpu>
80106ac0:	66 89 78 6e          	mov    %di,0x6e(%eax)
  asm volatile("ltr %0" : : "r" (sel));
80106ac4:	b8 28 00 00 00       	mov    $0x28,%eax
80106ac9:	0f 00 d8             	ltr    %ax
  lcr3(V2P(p->pgdir));  // switch to process's address space
80106acc:	8b 46 08             	mov    0x8(%esi),%eax
80106acf:	05 00 00 00 80       	add    $0x80000000,%eax
  asm volatile("movl %0,%%cr3" : : "r" (val));
80106ad4:	0f 22 d8             	mov    %eax,%cr3
}
...
80106add:	5d                   	pop    %ebp
  popcli();
80106ade:	e9 7d d9 ff ff       	jmp    80104460 <popcli>
    panic("switchuvm: no process");
80106ae3:	83 ec 0c             	sub    $0xc,%esp
80106ae6:	68 92 79 10 80       	push   $0x80107992
80106aeb:	e8 a0 98 ff ff       	call   80100390 <panic>
    panic("switchuvm: no pgdir");
80106af0:	83 ec 0c             	sub    $0xc,%esp
80106af3:	68 bd 79 10 80       	push   $0x801079bd
80106af8:	e8 93 98 ff ff       	call   80100390 <panic>
    panic("switchuvm: no kstack");
80106afd:	83 ec 0c             	sub    $0xc,%esp
80106b00:	68 a8 79 10 80       	push   $0x801079a8
80106b05:	e8 86 98 ff ff       	call   80100390 <panic>
...
80106b20:	8b 75 10             	mov    0x10(%ebp),%esi
80106b23:	8b 7d 08             	mov    0x8(%ebp),%edi
80106b26:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  if(sz >= PGSIZE)
80106b29:	81 fe ff 0f 00 00    	cmp    $0xfff,%esi
80106b2f:	77 4b                	ja     80106b7c <inituvm+0x6c>
  mem = kalloc();
80106b31:	e8 fa ba ff ff       	call   80102630 <kalloc>
  memset(mem, 0, PGSIZE);
80106b36:	83 ec 04             	sub    $0x4,%esp
80106b39:	68 00 10 00 00       	push   $0x1000
  mem = kalloc();
80106b3e:	89 c3                	mov    %eax,%ebx
  memset(mem, 0, PGSIZE);
80106b40:	6a 00                	push   $0x0
80106b42:	50                   	push   %eax
80106b43:	e8 d8 da ff ff       	call   80104620 <memset>
  mappages(pgdir, 0, PGSIZE, V2P(mem), PTE_W|PTE_U);
80106b48:	58                   	pop    %eax
80106b49:	8d 83 00 00 00 80    	lea    -0x80000000(%ebx),%eax
80106b4f:	5a                   	pop    %edx
80106b50:	6a 06                	push   $0x6
80106b52:	b9 00 10 00 00       	mov    $0x1000,%ecx
80106b57:	31 d2                	xor    %edx,%edx
80106b59:	50                   	push   %eax
80106b5a:	89 f8                	mov    %edi,%eax
80106b5c:	e8 af fc ff ff       	call   80106810 <mappages>
  memmove(mem, init, sz);
80106b61:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106b64:	89 75 10             	mov    %esi,0x10(%ebp)
80106b67:	83 c4 10             	add    $0x10,%esp
80106b6a:	89 5d 08             	mov    %ebx,0x8(%ebp)
80106b6d:	89 45 0c             	mov    %eax,0xc(%ebp)
}
...
80106b76:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106b77:	e9 44 db ff ff       	jmp    801046c0 <memmove>
    panic("inituvm: more than a page");
80106b7c:	83 ec 0c             	sub    $0xc,%esp
80106b7f:	68 d1 79 10 80       	push   $0x801079d1
...
80106ba0:	8b 75 18             	mov    0x18(%ebp),%esi
  if((uint) addr % PGSIZE != 0)
80106ba3:	a9 ff 0f 00 00       	test   $0xfff,%eax
80106ba8:	0f 85 99 00 00 00    	jne    80106c47 <loaduvm+0xb7>
  for(i = 0; i < sz; i += PGSIZE){
80106bae:	01 f0                	add    %esi,%eax
80106bb0:	89 f3                	mov    %esi,%ebx
80106bb2:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if(readi(ip, P2V(pa), offset+i, n) != n)
80106bb5:	8b 45 14             	mov    0x14(%ebp),%eax
80106bb8:	01 f0                	add    %esi,%eax
80106bba:	89 45 e0             	mov    %eax,-0x20(%ebp)
  for(i = 0; i < sz; i += PGSIZE){
80106bbd:	85 f6                	test   %esi,%esi
80106bbf:	75 15                	jne    80106bd6 <loaduvm+0x46>
80106bc1:	eb 6d                	jmp    80106c30 <loaduvm+0xa0>
80106bc3:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80106bc7:	90                   	nop
80106bc8:	81 eb 00 10 00 00    	sub    $0x1000,%ebx
80106bce:	89 f0                	mov    %esi,%eax
80106bd0:	29 d8                	sub    %ebx,%eax
80106bd2:	39 c6                	cmp    %eax,%esi
80106bd4:	76 5a                	jbe    80106c30 <loaduvm+0xa0>
    if((pte = walkpgdir(pgdir, addr+i, 0)) == 0)
80106bd6:	8b 55 e4             	mov    -0x1c(%ebp),%edx
80106bd9:	8b 45 08             	mov    0x8(%ebp),%eax
80106bdc:	31 c9                	xor    %ecx,%ecx
80106bde:	29 da                	sub    %ebx,%edx
80106be0:	e8 ab fb ff ff       	call   80106790 <walkpgdir>
80106be5:	85 c0                	test   %eax,%eax
80106be7:	74 51                	je     80106c3a <loaduvm+0xaa>
    pa = PTE_ADDR(*pte);
...
80106c0e:	e8 4d ae ff ff       	call   80101a60 <readi>
80106c13:	83 c4 10             	add    $0x10,%esp
80106c16:	39 f8                	cmp    %edi,%eax
80106c18:	74 ae                	je     80106bc8 <loaduvm+0x38>
}
...
80106c70:	8b 7d 08             	mov    0x8(%ebp),%edi
  if(newsz >= KERNBASE)
80106c73:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106c76:	85 c0                	test   %eax,%eax
80106c78:	0f 88 b2 00 00 00    	js     80106d30 <allocuvm+0xd0>
  if(newsz < oldsz)
80106c7e:	3b 45 0c             	cmp    0xc(%ebp),%eax
    return oldsz;
80106c81:	8b 45 0c             	mov    0xc(%ebp),%eax
  if(newsz < oldsz)
80106c84:	0f 82 96 00 00 00    	jb     80106d20 <allocuvm+0xc0>
  a = PGROUNDUP(oldsz);
80106c8a:	8d b0 ff 0f 00 00    	lea    0xfff(%eax),%esi
80106c90:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
  for(; a < newsz; a += PGSIZE){
80106c96:	39 75 10             	cmp    %esi,0x10(%ebp)
80106c99:	77 40                	ja     80106cdb <allocuvm+0x7b>
80106c9b:	e9 83 00 00 00       	jmp    80106d23 <allocuvm+0xc3>
    memset(mem, 0, PGSIZE);
80106ca0:	83 ec 04             	sub    $0x4,%esp
80106ca3:	68 00 10 00 00       	push   $0x1000
80106ca8:	6a 00                	push   $0x0
80106caa:	50                   	push   %eax
80106cab:	e8 70 d9 ff ff       	call   80104620 <memset>
...
80106cc4:	e8 47 fb ff ff       	call   80106810 <mappages>
...
80106cd9:	76 48                	jbe    80106d23 <allocuvm+0xc3>
    mem = kalloc();
80106cdb:	e8 50 b9 ff ff       	call   80102630 <kalloc>
...
80106ce9:	68 09 7a 10 80       	push   $0x80107a09
80106cee:	e8 bd 99 ff ff       	call   801006b0 <cprintf>
  if(newsz >= oldsz)
...
80106d05:	e8 96 fb ff ff       	call   801068a0 <deallocuvm.part.0>
      return 0;
...
80106d4b:	68 21 7a 10 80       	push   $0x80107a21
80106d50:	e8 5b 99 ff ff       	call   801006b0 <cprintf>
  if(newsz >= oldsz)
...
80106d67:	e8 34 fb ff ff       	call   801068a0 <deallocuvm.part.0>
      kfree(mem);
80106d6c:	83 ec 0c             	sub    $0xc,%esp
80106d6f:	53                   	push   %ebx
80106d70:	e8 fb b6 ff ff       	call   80102470 <kfree>
      return 0;
...
80106d97:	8b 55 0c             	mov    0xc(%ebp),%edx
80106d9a:	8b 4d 10             	mov    0x10(%ebp),%ecx
80106d9d:	8b 45 08             	mov    0x8(%ebp),%eax
  if(newsz >= oldsz)
80106da0:	39 d1                	cmp    %edx,%ecx
80106da2:	73 0c                	jae    80106db0 <deallocuvm+0x20>
}
80106da4:	5d                   	pop    %ebp
80106da5:	e9 f6 fa ff ff       	jmp    801068a0 <deallocuvm.part.0>
...
80106dd2:	74 55                	je     80106e29 <freevm+0x69>
  if(newsz >= oldsz)
80106dd4:	31 c9                	xor    %ecx,%ecx
80106dd6:	ba 00 00 00 80       	mov    $0x80000000,%edx
80106ddb:	89 f0                	mov    %esi,%eax
80106ddd:	89 f3                	mov    %esi,%ebx
80106ddf:	e8 bc fa ff ff       	call   801068a0 <deallocuvm.part.0>
    panic("freevm: no pgdir");
  deallocuvm(pgdir, KERNBASE, 0);
  for(i = 0; i < NPDENTRIES; i++){
80106de4:	8d be 00 10 00 00    	lea    0x1000(%esi),%edi
80106dea:	eb 0b                	jmp    80106df7 <freevm+0x37>
...
80106e0e:	e8 5d b6 ff ff       	call   80102470 <kfree>
...
80106e23:	5d                   	pop    %ebp
  kfree((char*)pgdir);
80106e24:	e9 47 b6 ff ff       	jmp    80102470 <kfree>
    panic("freevm: no pgdir");
80106e29:	83 ec 0c             	sub    $0xc,%esp
80106e2c:	68 3d 7a 10 80       	push   $0x80107a3d
...
80106e47:	56                   	push   %esi
80106e48:	53                   	push   %ebx
  if((pgdir = (pde_t*)kalloc()) == 0)
80106e49:	e8 e2 b7 ff ff       	call   80102630 <kalloc>
80106e4e:	89 c6                	mov    %eax,%esi
80106e50:	85 c0                	test   %eax,%eax
80106e52:	74 42                	je     80106e96 <setupkvm+0x56>
  memset(pgdir, 0, PGSIZE);
80106e54:	83 ec 04             	sub    $0x4,%esp
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
80106e57:	bb 20 a4 10 80       	mov    $0x8010a420,%ebx
  memset(pgdir, 0, PGSIZE);
80106e5c:	68 00 10 00 00       	push   $0x1000
80106e61:	6a 00                	push   $0x0
80106e63:	50                   	push   %eax
80106e64:	e8 b7 d7 ff ff       	call   80104620 <memset>
80106e69:	83 c4 10             	add    $0x10,%esp
                (uint)k->phys_start, k->perm) < 0) {
80106e6c:	8b 43 04             	mov    0x4(%ebx),%eax
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start,
80106e6f:	83 ec 08             	sub    $0x8,%esp
80106e72:	8b 4b 08             	mov    0x8(%ebx),%ecx
80106e75:	ff 73 0c             	pushl  0xc(%ebx)
80106e78:	8b 13                	mov    (%ebx),%edx
80106e7a:	50                   	push   %eax
80106e7b:	29 c1                	sub    %eax,%ecx
80106e7d:	89 f0                	mov    %esi,%eax
80106e7f:	e8 8c f9 ff ff       	call   80106810 <mappages>
80106e84:	83 c4 10             	add    $0x10,%esp
80106e87:	85 c0                	test   %eax,%eax
80106e89:	78 15                	js     80106ea0 <setupkvm+0x60>
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
80106e8b:	83 c3 10             	add    $0x10,%ebx
80106e8e:	81 fb 60 a4 10 80    	cmp    $0x8010a460,%ebx
80106e94:	75 d6                	jne    80106e6c <setupkvm+0x2c>
}
80106e96:	8d 65 f8             	lea    -0x8(%ebp),%esp
...
80106ec7:	83 ec 08             	sub    $0x8,%esp
  kpgdir = setupkvm();
80106eca:	e8 71 ff ff ff       	call   80106e40 <setupkvm>
80106ecf:	a3 a4 55 11 80       	mov    %eax,0x801155a4
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
80106ef2:	e8 99 f8 ff ff       	call   80106790 <walkpgdir>
  if(pte == 0)
80106ef7:	85 c0                	test   %eax,%eax
80106ef9:	74 05                	je     80106f00 <clearpteu+0x20>
    panic("clearpteu");
  *pte &= ~PTE_U;
80106efb:	83 20 fb             	andl   $0xfffffffb,(%eax)
}
80106efe:	c9                   	leave  
80106eff:	c3                   	ret    
    panic("clearpteu");
80106f00:	83 ec 0c             	sub    $0xc,%esp
80106f03:	68 4e 7a 10 80       	push   $0x80107a4e
...
80106f1a:	83 ec 1c             	sub    $0x1c,%esp
  ...
  if((d = setupkvm()) == 0)
80106f1d:	e8 1e ff ff ff       	call   80106e40 <setupkvm>
80106f22:	89 45 e0             	mov    %eax,-0x20(%ebp)
80106f25:	85 c0                	test   %eax,%eax
80106f27:	0f 84 9b 00 00 00    	je     80106fc8 <copyuvm+0xb8>
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
80106f2d:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80106f30:	85 c9                	test   %ecx,%ecx
80106f32:	0f 84 90 00 00 00    	je     80106fc8 <copyuvm+0xb8>
80106f38:	31 f6                	xor    %esi,%esi
80106f3a:	eb 46                	jmp    80106f82 <copyuvm+0x72>
...
80106f55:	58                   	pop    %eax
80106f56:	8d 83 00 00 00 80    	lea    -0x80000000(%ebx),%eax
80106f5c:	5a                   	pop    %edx
80106f5d:	ff 75 e4             	pushl  -0x1c(%ebp)
80106f60:	b9 00 10 00 00       	mov    $0x1000,%ecx
80106f65:	89 f2                	mov    %esi,%edx
80106f67:	50                   	push   %eax
80106f68:	8b 45 e0             	mov    -0x20(%ebp),%eax
80106f6b:	e8 a0 f8 ff ff       	call   80106810 <mappages>
...
80106f89:	e8 02 f8 ff ff       	call   80106790 <walkpgdir>
...
80106f96:	74 4e                	je     80106fe6 <copyuvm+0xd6>
    pa = PTE_ADDR(*pte);
80106f98:	89 c7                	mov    %eax,%edi
    flags = PTE_FLAGS(*pte);
80106f9a:	25 ff 0f 00 00       	and    $0xfff,%eax
80106f9f:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    pa = PTE_ADDR(*pte);
80106fa2:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
    if((mem = kalloc()) == 0)
80106fa8:	e8 83 b6 ff ff       	call   80102630 <kalloc>
80106fad:	89 c3                	mov    %eax,%ebx
...
80106fb9:	e8 02 fe ff ff       	call   80106dc0 <freevm>
  return 0;
80106fbe:	c7 45 e0 00 00 00 00 	movl   $0x0,-0x20(%ebp)
...
80107012:	e8 79 f7 ff ff       	call   80106790 <walkpgdir>
  if((*pte & PTE_P) == 0)
80107017:	8b 00                	mov    (%eax),%eax
    return 0;
  if((*pte & PTE_U) == 0)
    return 0;
...
8010701a:	89 c2                	mov    %eax,%edx
  return (char*)P2V(PTE_ADDR(*pte));
8010701c:	25 00 f0 ff ff       	and    $0xfffff000,%eax
  if((*pte & PTE_U) == 0)
80107021:	83 e2 05             	and    $0x5,%edx
  return (char*)P2V(PTE_ADDR(*pte));
80107024:	05 00 00 00 80       	add    $0x80000000,%eax
80107029:	83 fa 05             	cmp    $0x5,%edx
8010702c:	ba 00 00 00 00       	mov    $0x0,%edx
80107031:	0f 45 c2             	cmovne %edx,%eax
}
80107034:	c3                   	ret    
...
8010704d:	8b 75 14             	mov    0x14(%ebp),%esi
80107050:	8b 55 0c             	mov    0xc(%ebp),%edx
  char *buf, *pa0;
  uint n, va0;

  buf = (char*)p;
  while(len > 0){
80107053:	85 f6                	test   %esi,%esi
80107055:	75 3c                	jne    80107093 <copyout+0x53>
80107057:	eb 67                	jmp    801070c0 <copyout+0x80>
...
80107063:	89 fb                	mov    %edi,%ebx
80107065:	29 d3                	sub    %edx,%ebx
80107067:	81 c3 00 10 00 00    	add    $0x1000,%ebx
    if(n > len)
8010706d:	39 f3                	cmp    %esi,%ebx
8010706f:	0f 47 de             	cmova  %esi,%ebx
      n = len;
    memmove(pa0 + (va - va0), buf, n);
80107072:	29 fa                	sub    %edi,%edx
80107074:	83 ec 04             	sub    $0x4,%esp
80107077:	01 c2                	add    %eax,%edx
80107079:	53                   	push   %ebx
8010707a:	ff 75 10             	pushl  0x10(%ebp)
8010707d:	52                   	push   %edx
8010707e:	e8 3d d6 ff ff       	call   801046c0 <memmove>
    len -= n;
    buf += n;
80107083:	01 5d 10             	add    %ebx,0x10(%ebp)
    va = va0 + PGSIZE;
80107086:	8d 97 00 10 00 00    	lea    0x1000(%edi),%edx
  while(len > 0){
8010708c:	83 c4 10             	add    $0x10,%esp
8010708f:	29 de                	sub    %ebx,%esi
80107091:	74 2d                	je     801070c0 <copyout+0x80>
    va0 = (uint)PGROUNDDOWN(va);
80107093:	89 d7                	mov    %edx,%edi
    pa0 = uva2ka(pgdir, (char*)va0);
80107095:	83 ec 08             	sub    $0x8,%esp
    va0 = (uint)PGROUNDDOWN(va);
80107098:	89 55 0c             	mov    %edx,0xc(%ebp)
8010709b:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
    pa0 = uva2ka(pgdir, (char*)va0);
801070a1:	57                   	push   %edi
801070a2:	ff 75 08             	pushl  0x8(%ebp)
801070a5:	e8 56 ff ff ff       	call   80107000 <uva2ka>
    if(pa0 == 0)
801070aa:	83 c4 10             	add    $0x10,%esp
801070ad:	85 c0                	test   %eax,%eax
801070af:	75 af                	jne    80107060 <copyout+0x20>
  }
  return 0;
}
